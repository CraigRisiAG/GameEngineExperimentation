...
public:
  ...
  void set_expand_margin_size_individual(float p_left, float p_top,
                                         float p_right, float p_bottom);
...
public:
  ...
  void set_corner_radius_individual(const int radius_top_left,
