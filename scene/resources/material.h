...
public:
  ...
  enum DetailUV { DETAIL_UV_1, DETAIL_UV_2 };
  ...
  enum CullMode { CULL_BACK, CULL_FRONT, CULL_DISABLED };
...
private:
  ...
  _FORCE_INLINE_ void _validate_feature(const String &text, Feature feature,
...
public:
  ...
  void
  set_subsurface_scattering_strength(float p_subsurface_scattering_strength);
  ...
  static RID get_material_rid_for_2d(bool p_shaded, bool p_transparent,
                                     bool p_double_sided, bool p_cut_alpha,
