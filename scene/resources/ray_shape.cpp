...
real_t RayShape::get_enclosing_radius() const { return length; }
...
float RayShape::get_length() const { return length; }
...
bool RayShape::get_slips_on_slope() const { return slips_on_slope; }
