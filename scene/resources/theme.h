...
public:
  ...
  void set_icon(const StringName &p_name, const StringName &p_type,
  ...
  void set_shader(const StringName &p_name, const StringName &p_type,
  ...
  void get_shader_list(const StringName &p_type,
                       List<StringName> *p_list) const;

  void set_stylebox(const StringName &p_name, const StringName &p_type,
  ...
  void set_font(const StringName &p_name, const StringName &p_type,
  ...
  void set_color(const StringName &p_name, const StringName &p_type,
                 const Color &p_color);
  ...
  void set_constant(const StringName &p_name, const StringName &p_type,
                    int p_constant);
