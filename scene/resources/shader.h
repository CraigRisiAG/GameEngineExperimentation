...
private:
  ...
  // shaders keep a list of ShaderMaterial -> VisualServer name translations, to
  // make conversion fast and save memory.
...
public:
  ...
  void set_default_texture_param(const StringName &p_param,
