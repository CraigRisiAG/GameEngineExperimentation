...
void PrimitiveMesh::_update() const {
  ...
  VisualServer::get_singleton()->mesh_add_surface_from_arrays(
      mesh, (VisualServer::PrimitiveType)primitive_type, arr);
  VisualServer::get_singleton()->mesh_surface_set_material(
      mesh, 0, material.is_null() ? RID() : material->get_rid());
...
uint32_t PrimitiveMesh::surface_get_format(int p_idx) const {
  ...
  return VS::ARRAY_FORMAT_VERTEX | VS::ARRAY_FORMAT_NORMAL |
         VS::ARRAY_FORMAT_TANGENT | VS::ARRAY_FORMAT_TEX_UV |
         VS::ARRAY_FORMAT_INDEX | VS::ARRAY_COMPRESS_DEFAULT;
}
...
void PrimitiveMesh::surface_set_material(int p_idx,
...
void PrimitiveMesh::_bind_methods() {
  ...
  ClassDB::bind_method(D_METHOD("get_mesh_arrays"),
  ...
  ClassDB::bind_method(D_METHOD("set_flip_faces", "flip_faces"),
                       &PrimitiveMesh::set_flip_faces);
  ClassDB::bind_method(D_METHOD("get_flip_faces"),
  ...
  ADD_PROPERTY(PropertyInfo(Variant::BOOL, "flip_faces"), "set_flip_faces",
               "get_flip_faces");
}
...
PrimitiveMesh::PrimitiveMesh() {
  ...
  // assume primitive triangles as the type, correct for all but one and it will
  // change this :)
...
PrimitiveMesh::~PrimitiveMesh() { VisualServer::get_singleton()->free(mesh); }
...
void CapsuleMesh::_bind_methods() {
  ...
  ClassDB::bind_method(D_METHOD("set_mid_height", "mid_height"),
                       &CapsuleMesh::set_mid_height);
  ClassDB::bind_method(D_METHOD("get_mid_height"),
                       &CapsuleMesh::get_mid_height);

  ClassDB::bind_method(D_METHOD("set_radial_segments", "segments"),
                       &CapsuleMesh::set_radial_segments);
  ClassDB::bind_method(D_METHOD("get_radial_segments"),
  ...
  ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "mid_height", PROPERTY_HINT_RANGE,
                            "0.001,100.0,0.001,or_greater"),
               "set_mid_height", "get_mid_height");
  ADD_PROPERTY(PropertyInfo(Variant::INT, "radial_segments",
                            PROPERTY_HINT_RANGE, "1,100,1,or_greater"),
...
#define ADD_TANGENT(m_x, m_y, m_z, m_d)                                        \
  ...
  for (j = 0; j <= subdivide_h + 1; j++) {
    ...
    for (i = 0; i <= subdivide_w + 1; i++) {
      ...
      // front
      points.push_back(
          Vector3(x, -y, -start_pos.z)); // double negative on the Z!
...
void CubeMesh::_bind_methods() {
  ...
  ClassDB::bind_method(D_METHOD("set_subdivide_width", "subdivide"),
                       &CubeMesh::set_subdivide_width);
  ClassDB::bind_method(D_METHOD("get_subdivide_width"),
                       &CubeMesh::get_subdivide_width);
  ClassDB::bind_method(D_METHOD("set_subdivide_height", "divisions"),
                       &CubeMesh::set_subdivide_height);
  ClassDB::bind_method(D_METHOD("get_subdivide_height"),
                       &CubeMesh::get_subdivide_height);
  ClassDB::bind_method(D_METHOD("set_subdivide_depth", "divisions"),
                       &CubeMesh::set_subdivide_depth);
  ClassDB::bind_method(D_METHOD("get_subdivide_depth"),
                       &CubeMesh::get_subdivide_depth);

  ADD_PROPERTY(PropertyInfo(Variant::VECTOR3, "size"), "set_size", "get_size");
  ADD_PROPERTY(PropertyInfo(Variant::INT, "subdivide_width",
                            PROPERTY_HINT_RANGE, "0,100,1,or_greater"),
               "set_subdivide_width", "get_subdivide_width");
  ADD_PROPERTY(PropertyInfo(Variant::INT, "subdivide_height",
                            PROPERTY_HINT_RANGE, "0,100,1,or_greater"),
               "set_subdivide_height", "get_subdivide_height");
  ADD_PROPERTY(PropertyInfo(Variant::INT, "subdivide_depth",
                            PROPERTY_HINT_RANGE, "0,100,1,or_greater"),
...
Vector3 CubeMesh::get_size() const { return size; }
...
int CubeMesh::get_subdivide_width() const { return subdivide_w; }
...
int CubeMesh::get_subdivide_height() const { return subdivide_h; }
...
int CubeMesh::get_subdivide_depth() const { return subdivide_d; }
...
void CylinderMesh::_bind_methods() {
  ClassDB::bind_method(D_METHOD("set_top_radius", "radius"),
                       &CylinderMesh::set_top_radius);
  ClassDB::bind_method(D_METHOD("get_top_radius"),
                       &CylinderMesh::get_top_radius);
  ClassDB::bind_method(D_METHOD("set_bottom_radius", "radius"),
                       &CylinderMesh::set_bottom_radius);
  ClassDB::bind_method(D_METHOD("get_bottom_radius"),
  ...
  ClassDB::bind_method(D_METHOD("set_rings", "rings"),
                       &CylinderMesh::set_rings);
  ClassDB::bind_method(D_METHOD("get_rings"), &CylinderMesh::get_rings);

  ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "top_radius", PROPERTY_HINT_RANGE,
                            "0.001,100.0,0.001,or_greater"),
               "set_top_radius", "get_top_radius");
  ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "bottom_radius",
                            PROPERTY_HINT_RANGE,
                            "0.001,100.0,0.001,or_greater"),
               "set_bottom_radius", "get_bottom_radius");
  ...
  for (j = 0; j <= (subdivide_d + 1); j++) {
    ...
    for (i = 0; i <= (subdivide_w + 1); i++) {
      ...
      uvs.push_back(Vector2(
          1.0 - u, 1.0 - v)); /* 1.0 - uv to match orientation with Quad */
      point++;
...
void PlaneMesh::_bind_methods() {
  ...
  ClassDB::bind_method(D_METHOD("set_subdivide_depth", "subdivide"),
...
#define ADD_TANGENT(m_x, m_y, m_z, m_d)                                        \
  ...
  for (j = 0; j <= (subdivide_h + 1); j++) {
    ...
    for (i = 0; i <= (subdivide_w + 1); i++) {
      ...
      /* front */
      points.push_back(
          Vector3(start_x + x, -y, -start_pos.z)); // double negative on the Z!
      normals.push_back(Vector3(0.0, 0.0, 1.0));
      ADD_TANGENT(1.0, 0.0, 0.0, 1.0);
...
void PrismMesh::_bind_methods() {
  ClassDB::bind_method(D_METHOD("set_left_to_right", "left_to_right"),
                       &PrismMesh::set_left_to_right);
  ClassDB::bind_method(D_METHOD("get_left_to_right"),
  ...
  ClassDB::bind_method(D_METHOD("set_subdivide_width", "segments"),
                       &PrismMesh::set_subdivide_width);
  ClassDB::bind_method(D_METHOD("get_subdivide_width"),
                       &PrismMesh::get_subdivide_width);
  ClassDB::bind_method(D_METHOD("set_subdivide_height", "segments"),
                       &PrismMesh::set_subdivide_height);
  ClassDB::bind_method(D_METHOD("get_subdivide_height"),
                       &PrismMesh::get_subdivide_height);
  ClassDB::bind_method(D_METHOD("set_subdivide_depth", "segments"),
                       &PrismMesh::set_subdivide_depth);
  ClassDB::bind_method(D_METHOD("get_subdivide_depth"),
                       &PrismMesh::get_subdivide_depth);

  ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "left_to_right",
                            PROPERTY_HINT_RANGE, "-2.0,2.0,0.1"),
               "set_left_to_right", "get_left_to_right");
  ADD_PROPERTY(PropertyInfo(Variant::VECTOR3, "size"), "set_size", "get_size");
  ADD_PROPERTY(PropertyInfo(Variant::INT, "subdivide_width",
                            PROPERTY_HINT_RANGE, "0,100,1,or_greater"),
               "set_subdivide_width", "get_subdivide_width");
...
Size2 QuadMesh::get_size() const { return size; }
...
void SphereMesh::_bind_methods() {
  ...
  ClassDB::bind_method(D_METHOD("set_radial_segments", "radial_segments"),
  ...
  ClassDB::bind_method(D_METHOD("set_is_hemisphere", "is_hemisphere"),
                       &SphereMesh::set_is_hemisphere);
  ClassDB::bind_method(D_METHOD("get_is_hemisphere"),
  ...
  ADD_PROPERTY(PropertyInfo(Variant::INT, "rings", PROPERTY_HINT_RANGE,
                            "1,100,1,or_greater"),
               "set_rings", "get_rings");
  ADD_PROPERTY(PropertyInfo(Variant::BOOL, "is_hemisphere"),
               "set_is_hemisphere", "get_is_hemisphere");
}
