...
real_t BoxShape::get_enclosing_radius() const { return extents.length(); }
...
Vector3 BoxShape::get_extents() const { return extents; }
...
void BoxShape::_bind_methods() {
  ...
  ADD_PROPERTY(PropertyInfo(Variant::VECTOR3, "extents"), "set_extents",
               "get_extents");
}
