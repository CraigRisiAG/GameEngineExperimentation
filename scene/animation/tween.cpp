...
void Tween::_add_pending_command(StringName p_key, const Variant &p_arg1,
                                 const Variant &p_arg2, const Variant &p_arg3,
                                 const Variant &p_arg4, const Variant &p_arg5,
                                 const Variant &p_arg6, const Variant &p_arg7,
                                 const Variant &p_arg8, const Variant &p_arg9,
...
void Tween::_process_pending_commands() {
  ...
  for (List<PendingCommand>::Element *E = pending_commands.front(); E;
    ...
    Variant *arg[10] = {
        ...
        &cmd.arg[5], &cmd.arg[6], &cmd.arg[7], &cmd.arg[8], &cmd.arg[9],
    };
...
void Tween::_get_property_list(List<PropertyInfo> *p_list) const {
  ...
  p_list->push_back(
      PropertyInfo(Variant::BOOL, "playback/active", PROPERTY_HINT_NONE, ""));
  p_list->push_back(
      PropertyInfo(Variant::BOOL, "playback/repeat", PROPERTY_HINT_NONE, ""));
  p_list->push_back(PropertyInfo(Variant::FLOAT, "playback/speed",
...
void Tween::_bind_methods() {
  ...
  ClassDB::bind_method(D_METHOD("set_tween_process_mode", "mode"),
                       &Tween::set_tween_process_mode);
  ClassDB::bind_method(D_METHOD("get_tween_process_mode"),
  ...
  ClassDB::bind_method(D_METHOD("remove", "object", "key"), &Tween::remove,
                       DEFVAL(""));
  ClassDB::bind_method(D_METHOD("_remove_by_uid", "uid"),
                       &Tween::_remove_by_uid);
  ...
  ClassDB::bind_method(D_METHOD("interpolate_property", "object", "property",
                                "initial_val", "final_val", "duration",
                                "trans_type", "ease_type", "delay"),
                       &Tween::interpolate_property, DEFVAL(TRANS_LINEAR),
                       DEFVAL(EASE_IN_OUT), DEFVAL(0));
  ClassDB::bind_method(D_METHOD("interpolate_method", "object", "method",
                                "initial_val", "final_val", "duration",
                                "trans_type", "ease_type", "delay"),
                       &Tween::interpolate_method, DEFVAL(TRANS_LINEAR),
                       DEFVAL(EASE_IN_OUT), DEFVAL(0));
  ClassDB::bind_method(
      D_METHOD("interpolate_callback", "object", "duration", "callback", "arg1",
               "arg2", "arg3", "arg4", "arg5"),
      &Tween::interpolate_callback, DEFVAL(Variant()), DEFVAL(Variant()),
      DEFVAL(Variant()), DEFVAL(Variant()), DEFVAL(Variant()));
  ClassDB::bind_method(D_METHOD("interpolate_deferred_callback", "object",
                                "duration", "callback", "arg1", "arg2", "arg3",
                                "arg4", "arg5"),
                       &Tween::interpolate_deferred_callback, DEFVAL(Variant()),
                       DEFVAL(Variant()), DEFVAL(Variant()), DEFVAL(Variant()),
                       DEFVAL(Variant()));
  ClassDB::bind_method(D_METHOD("follow_property", "object", "property",
                                "initial_val", "target", "target_property",
                                "duration", "trans_type", "ease_type", "delay"),
                       &Tween::follow_property, DEFVAL(TRANS_LINEAR),
                       DEFVAL(EASE_IN_OUT), DEFVAL(0));
  ClassDB::bind_method(D_METHOD("follow_method", "object", "method",
                                "initial_val", "target", "target_method",
                                "duration", "trans_type", "ease_type", "delay"),
                       &Tween::follow_method, DEFVAL(TRANS_LINEAR),
                       DEFVAL(EASE_IN_OUT), DEFVAL(0));
  ClassDB::bind_method(D_METHOD("targeting_property", "object", "property",
                                "initial", "initial_val", "final_val",
                                "duration", "trans_type", "ease_type", "delay"),
                       &Tween::targeting_property, DEFVAL(TRANS_LINEAR),
                       DEFVAL(EASE_IN_OUT), DEFVAL(0));
  ClassDB::bind_method(D_METHOD("targeting_method", "object", "method",
                                "initial", "initial_method", "final_val",
                                "duration", "trans_type", "ease_type", "delay"),
                       &Tween::targeting_method, DEFVAL(TRANS_LINEAR),
                       DEFVAL(EASE_IN_OUT), DEFVAL(0));

  // Add the Tween signals
  ADD_SIGNAL(MethodInfo("tween_started",
                        PropertyInfo(Variant::OBJECT, "object"),
                        PropertyInfo(Variant::NODE_PATH, "key")));
  ADD_SIGNAL(MethodInfo("tween_step", PropertyInfo(Variant::OBJECT, "object"),
                        PropertyInfo(Variant::NODE_PATH, "key"),
                        PropertyInfo(Variant::FLOAT, "elapsed"),
                        PropertyInfo(Variant::OBJECT, "value")));
  ADD_SIGNAL(MethodInfo("tween_completed",
                        PropertyInfo(Variant::OBJECT, "object"),
                        PropertyInfo(Variant::NODE_PATH, "key")));
  ADD_SIGNAL(MethodInfo("tween_all_completed"));

  // Add the properties and tie them to the getters and setters
  ADD_PROPERTY(PropertyInfo(Variant::BOOL, "repeat"), "set_repeat",
               "is_repeat");
  ADD_PROPERTY(PropertyInfo(Variant::INT, "playback_process_mode",
                            PROPERTY_HINT_ENUM, "Physics,Idle"),
               "set_tween_process_mode", "get_tween_process_mode");
...
Variant Tween::_get_initial_val(const InterpolateData &p_data) const {
  ...
  case TARGETING_METHOD: {
    ...
    if (p_data.type == TARGETING_PROPERTY) {
      ...
      ERR_FAIL_COND_V(error.error != Callable::CallError::CALL_OK,
                      p_data.initial_val);
    }
    return initial_val;
  }
...
Variant Tween::_get_final_val(const InterpolateData &p_data) const {
  ...
  default: {
    // If we're not following a final value/method, use the final value from the
    // data
...
#define APPLY_EQUATION(element)                                                \
  r.element = _run_equation(p_data.trans_type, p_data.ease_type,               \
                            p_data.elapsed - p_data.delay, i.element,          \
                            d.element, p_data.duration);
  ...
  case Variant::BOOL:
    ...
    result = (_run_equation(p_data.trans_type, p_data.ease_type,
                            p_data.elapsed - p_data.delay, initial_val,
                            delta_val, p_data.duration)) >= 0.5;
    break;

  case Variant::INT:
    // Run the integer specific equation
    result = (int)_run_equation(p_data.trans_type, p_data.ease_type,
                                p_data.elapsed - p_data.delay, (int)initial_val,
                                (int)delta_val, p_data.duration);
    break;

  case Variant::FLOAT:
    // Run the FLOAT specific equation
    result = _run_equation(p_data.trans_type, p_data.ease_type,
                           p_data.elapsed - p_data.delay, (real_t)initial_val,
                           (real_t)delta_val, p_data.duration);
    break;
  ...
  case Variant::AABB: {
    ...
    // Execute the equation for the position and size of the AABB's and mutate
    // the r AABB This uses the custom APPLY_EQUATION macro defined above
    APPLY_EQUATION(position.x);
    APPLY_EQUATION(position.y);
  ...
  case Variant::TRANSFORM: {
    ...
    // Execute the equation for each of the transforms and their origin and
    // mutate the r transform This uses the custom APPLY_EQUATION macro defined
    // above
...
void Tween::_tween_process(float p_delta) {
  ...
  for (List<InterpolateData>::Element *E = interpolates.front(); E;
    ...
    if (data.elapsed < data.delay)
      ...
      // We can apply the tween's value to the data and emit that the tween has
      // started
      _apply_tween_value(data, data.initial_val);
      emit_signal("tween_started", object,
                  NodePath(Vector<StringName>(), data.key, false));
    }
    ...
    if (data.type == INTER_CALLBACK) {
      ...
      if (data.finish) {
        ...
        if (data.call_deferred) {
          // Run the deferred function callback, applying the correct number of
          // arguments
          switch (data.args) {
          case 0:
          ...
          case 4:
            object->call_deferred(data.key[0], data.arg[0], data.arg[1],
                                  data.arg[2], data.arg[3]);
            break;
          case 5:
            object->call_deferred(data.key[0], data.arg[0], data.arg[1],
                                  data.arg[2], data.arg[3], data.arg[4]);
            break;
          }
        } else {
          ...
          Callable::CallError error;
          Variant *arg[5] = {
              &data.arg[0], &data.arg[1], &data.arg[2],
              &data.arg[3], &data.arg[4],
          };
      ...
      emit_signal("tween_step", object,
                  NodePath(Vector<StringName>(), data.key, false), data.elapsed,
                  result);
    }
    ...
    if (data.finish) {
      ...
      data.elapsed = 0;
      emit_signal("tween_completed", object,
                  NodePath(Vector<StringName>(), data.key, false));
...
bool Tween::is_repeat() const { return repeat; }

void Tween::set_repeat(bool p_repeat) { repeat = p_repeat; }

void Tween::set_speed_scale(float p_speed) { speed_scale = p_speed; }

float Tween::get_speed_scale() const { return speed_scale; }
...
void Tween::remove(Object *p_object, StringName p_key) {
  ...
  for (List<List<InterpolateData>::Element *>::Element *E = for_removal.front();
       E; E = E->next()) {
    // Erase it
...
void Tween::seek(real_t p_time) {
  ...
  for (List<InterpolateData>::Element *E = interpolates.front(); E;
    ...
    if (data.elapsed < data.delay) {
      ...
      // We are past the end of it, set the elapsed time to the end and mark as
      // finished
      data.elapsed = (data.delay + data.duration);
      data.finish = true;
    } else {
...
real_t Tween::tell() const {
  ...
  for (const List<InterpolateData>::Element *E = interpolates.front(); E;
       E = E->next()) {
    // Get the data and figure out if it's position is further along than the
    // previous ones
...
real_t Tween::get_runtime() const {
  ...
  for (const List<InterpolateData>::Element *E = interpolates.front(); E;
       E = E->next()) {
    // Get the tween data and see if it's runtime is greater than the previous
    // tweens
    const InterpolateData &data = E->get();
...
bool Tween::_calc_delta_val(const Variant &p_initial_val,
  ...
  case Variant::TRANSFORM2D: {
    // Build a new transform which is the difference between the initial and
    // final values
    Transform2D i = initial_val;
  ...
  case Variant::TRANSFORM: {
    ...
    d.set(f.basis.elements[0][0] - i.basis.elements[0][0],
          ...
          f.origin.x - i.origin.x, f.origin.y - i.origin.y,
  ...
  case Variant::COLOR: {
    // Make a new color which is the difference between each the color's RGBA
    // attributes
    Color i = initial_val;
    Color f = final_val;
  ...
  default: {
    static Variant::Type supported_types[] = {
        ...
        Variant::VECTOR2,     Variant::RECT2,     Variant::VECTOR3,
        Variant::TRANSFORM2D, Variant::QUAT,      Variant::AABB,
        Variant::BASIS,       Variant::TRANSFORM, Variant::COLOR,
    };
...
void Tween::_build_interpolation(InterpolateType p_interpolation_type,
                                 Object *p_object, NodePath *p_property,
                                 StringName *p_method, Variant p_initial_val,
                                 Variant p_final_val, real_t p_duration,
                                 TransitionType p_trans_type,
                                 EaseType p_ease_type, real_t p_delay) {
  ...
  ERR_FAIL_COND_MSG(p_initial_val.get_type() != p_final_val.get_type(),
                    "Initial value type '" +
                        Variant::get_type_name(p_initial_val.get_type()) +
                        "' does not match final value type '" +
  ...
  ERR_FAIL_COND_MSG(p_duration < 0,
                    "Only non-negative duration values allowed in Tweens.");
  data.duration = p_duration;

  // Tween Delay
  ERR_FAIL_COND_MSG(p_delay < 0,
                    "Only non-negative delay values allowed in Tweens.");
  data.delay = p_delay;

  // Transition type
  ERR_FAIL_COND_MSG(p_trans_type < 0 || p_trans_type >= TRANS_COUNT,
                    "Invalid transition type provided to Tween.");
  data.trans_type = p_trans_type;

  // Easing type
  ERR_FAIL_COND_MSG(p_ease_type < 0 || p_ease_type >= EASE_COUNT,
  ...
  if (p_property) {
    ...
    ERR_FAIL_COND_MSG(!prop_valid,
                      "Tween target object has no property named: " +
  ...
  if (p_method) {
    ...
    ERR_FAIL_COND_MSG(!p_object->has_method(*p_method),
                      "Tween target object has no method named: " + *p_method +
                          ".");
...
void Tween::interpolate_property(Object *p_object, NodePath p_property,
                                 Variant p_initial_val, Variant p_final_val,
                                 real_t p_duration, TransitionType p_trans_type,
                                 EaseType p_ease_type, real_t p_delay) {
  // If we are busy updating, call this function again later
  if (pending_update != 0) {
    _add_pending_command("interpolate_property", p_object, p_property,
                         p_initial_val, p_final_val, p_duration, p_trans_type,
                         p_ease_type, p_delay);
    return;
  }
  ...
  // TODO: Is this documented? This is very useful and removes a lot of clutter
  // from tweens!
  ...
  _build_interpolation(INTER_PROPERTY, p_object, &p_property, NULL,
                       p_initial_val, p_final_val, p_duration, p_trans_type,
                       p_ease_type, p_delay);
}

void Tween::interpolate_method(Object *p_object, StringName p_method,
                               Variant p_initial_val, Variant p_final_val,
                               real_t p_duration, TransitionType p_trans_type,
                               EaseType p_ease_type, real_t p_delay) {
  // If we are busy updating, call this function again later
  if (pending_update != 0) {
    _add_pending_command("interpolate_method", p_object, p_method,
                         p_initial_val, p_final_val, p_duration, p_trans_type,
                         p_ease_type, p_delay);
    return;
  }
  ...
  // Build the interpolation data
  _build_interpolation(INTER_METHOD, p_object, NULL, &p_method, p_initial_val,
                       p_final_val, p_duration, p_trans_type, p_ease_type,
                       p_delay);
}

void Tween::interpolate_callback(Object *p_object, real_t p_duration,
                                 String p_callback, VARIANT_ARG_DECLARE) {
  // If we are already updating, call this function again later
  if (pending_update != 0) {
    _add_pending_command("interpolate_callback", p_object, p_duration,
                         p_callback, p_arg1, p_arg2, p_arg3, p_arg4, p_arg5);
    return;
  }
  ...
  ERR_FAIL_COND_MSG(!p_object->has_method(p_callback),
                    "Object has no callback named: " + p_callback + ".");
...
void Tween::interpolate_deferred_callback(Object *p_object, real_t p_duration,
                                          String p_callback,
                                          VARIANT_ARG_DECLARE) {
  // If we are already updating, call this function again later
  if (pending_update != 0) {
    _add_pending_command("interpolate_deferred_callback", p_object, p_duration,
                         p_callback, p_arg1, p_arg2, p_arg3, p_arg4, p_arg5);
    return;
  }
...
void Tween::follow_property(Object *p_object, NodePath p_property,
                            Variant p_initial_val, Object *p_target,
                            NodePath p_target_property, real_t p_duration,
                            TransitionType p_trans_type, EaseType p_ease_type,
                            real_t p_delay) {
  // If we are already updating, call this function again later
  if (pending_update != 0) {
    _add_pending_command("follow_property", p_object, p_property, p_initial_val,
                         p_target, p_target_property, p_duration, p_trans_type,
                         p_ease_type, p_delay);
    return;
  }
...
void Tween::follow_method(Object *p_object, StringName p_method,
                          Variant p_initial_val, Object *p_target,
                          StringName p_target_method, real_t p_duration,
                          TransitionType p_trans_type, EaseType p_ease_type,
                          real_t p_delay) {
  // If we are currently updating, call this function again later
  if (pending_update != 0) {
    _add_pending_command("follow_method", p_object, p_method, p_initial_val,
                         p_target, p_target_method, p_duration, p_trans_type,
                         p_ease_type, p_delay);
    return;
  }
  // Convert initial INT values to FLOAT as they are better for interpolation
  ...
  ERR_FAIL_COND_MSG(!p_object->has_method(p_method),
                    "Object has no method named: " + p_method + ".");
  ERR_FAIL_COND_MSG(!p_target->has_method(p_target_method),
                    "Target has no method named: " + p_target_method + ".");
...
void Tween::targeting_property(Object *p_object, NodePath p_property,
                               Object *p_initial, NodePath p_initial_property,
                               Variant p_final_val, real_t p_duration,
                               TransitionType p_trans_type,
                               EaseType p_ease_type, real_t p_delay) {
  // If we are currently updating, call this function again later
  if (pending_update != 0) {
    _add_pending_command("targeting_property", p_object, p_property, p_initial,
                         p_initial_property, p_final_val, p_duration,
                         p_trans_type, p_ease_type, p_delay);
    return;
  }
  ...
  // Convert the initial INT values to FLOAT as they are better for
  // Interpolation
  if (p_final_val.get_type() == Variant::INT)
    p_final_val = p_final_val.operator real_t();
  ...
  Variant initial_val = p_initial->get_indexed(
      p_initial_property.get_subnames(), &initial_prop_valid);
...
void Tween::targeting_method(Object *p_object, StringName p_method,
                             Object *p_initial, StringName p_initial_method,
                             Variant p_final_val, real_t p_duration,
                             TransitionType p_trans_type, EaseType p_ease_type,
                             real_t p_delay) {
  // If we are currently updating, call this function again later
  if (pending_update != 0) {
    _add_pending_command("targeting_method", p_object, p_method, p_initial,
                         p_initial_method, p_final_val, p_duration,
                         p_trans_type, p_ease_type, p_delay);
    return;
  }
  ...
  ERR_FAIL_COND_MSG(!p_object->has_method(p_method),
                    "Object has no method named: " + p_method + ".");
  ERR_FAIL_COND_MSG(!p_initial->has_method(p_initial_method),
                    "Initial Object has no method named: " + p_initial_method +
                        ".");
