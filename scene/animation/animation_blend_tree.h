...
public:
  enum MixMode { MIX_MODE_BLEND, MIX_MODE_ADD };
...
public:
  ...
  void connect_node(const StringName &p_input_node, int p_input_index,
  ...
  ConnectionError can_connect_node(const StringName &p_input_node,
                                   int p_input_index,
