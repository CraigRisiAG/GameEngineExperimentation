...
protected:
  ...
  void _blend_triangle(const Vector2 &p_pos, const Vector2 *p_points,
                       float *r_weights);
...
public:
  ...
  void add_blend_point(const Ref<AnimationRootNode> &p_node,
                       const Vector2 &p_position, int p_at_index = -1);
