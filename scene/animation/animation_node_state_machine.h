...
class AnimationNodeStateMachinePlayback : public Resource {
  ...
  bool _travel(AnimationNodeStateMachine *p_state_machine,
               const StringName &p_travel);

  float process(AnimationNodeStateMachine *p_state_machine, float p_time,
                bool p_seek);
...
public:
  ...
  void
  add_transition(const StringName &p_from, const StringName &p_to,
                 const Ref<AnimationNodeStateMachineTransition> &p_transition);
  Ref<AnimationNodeStateMachineTransition>
  get_transition(int p_transition) const;
