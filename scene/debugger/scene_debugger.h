...
private:
  ...
  static void _set_object_property(ObjectID p_id, const String &p_property,
                                   const Variant &p_value);
  static void _send_object_id(ObjectID p_id, int p_max_size = 1 << 20);

public:
  static Error parse_message(void *p_user, const String &p_msg,
...
public:
  struct RemoteNode {
    ...
    RemoteNode(int p_child, const String &p_name, const String &p_type,
               ObjectID p_id) {
      child_count = p_child;
      name = p_name;
      type_name = p_type;
...
private:
  ...
  void _node_set_func(int p_id, const StringName &p_prop,
                      const Variant &p_value);
  void _node_set_res_func(int p_id, const StringName &p_prop,
                          const String &p_value);
  void _node_call_func(int p_id, const StringName &p_method,
                       VARIANT_ARG_DECLARE);
  void _res_set_func(int p_id, const StringName &p_prop,
                     const Variant &p_value);
  void _res_set_res_func(int p_id, const StringName &p_prop,
                         const String &p_value);
  void _res_call_func(int p_id, const StringName &p_method,
                      VARIANT_ARG_DECLARE);
  void _root_func(const NodePath &p_scene_path, const String &p_scene_from);

  void _create_node_func(const NodePath &p_parent, const String &p_type,
                         const String &p_name);
  void _instance_node_func(const NodePath &p_parent, const String &p_path,
                           const String &p_name);
  ...
  void _reparent_node_func(const NodePath &p_at, const NodePath &p_new_place,
