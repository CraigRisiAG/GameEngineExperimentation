...
void register_scene_types() {
  ...
  ClassDB::set_class_enabled("RootMotionView",
                             false); // disabled by default, enabled by editor
  ...
  AcceptDialog::set_swap_ok_cancel(
      GLOBAL_DEF("gui/common/swap_ok_cancel",
  ...
  ClassDB::register_virtual_class<SceneTreeTimer>(); // sorry, you can't create
                                                     // it
  ...
  ClassDB::add_compatibility_class("VisualShaderNodeScalarConstant",
                                   "VisualShaderNodeFloatConstant");
  ClassDB::add_compatibility_class("VisualShaderNodeScalarUniform",
                                   "VisualShaderNodeFloatUniform");
  ClassDB::add_compatibility_class("VisualShaderNodeScalarOp",
                                   "VisualShaderNodeFloatOp");
  ClassDB::add_compatibility_class("VisualShaderNodeScalarFunc",
                                   "VisualShaderNodeFloatFunc");
  ClassDB::add_compatibility_class("NavigationMeshInstance",
                                   "NavigationRegion");
  ClassDB::add_compatibility_class("NavigationPolygonInstance",
                                   "NavigationRegion2D");
  ...
  ProjectSettings::get_singleton()->set_custom_property_info(
      "gui/theme/use_hidpi",
      PropertyInfo(Variant::BOOL, "gui/theme/use_hidpi", PROPERTY_HINT_NONE, "",
...
void unregister_scene_types() {
  ...
  // StandardMaterial3D is not initialised when 3D is disabled, so it shouldn't
