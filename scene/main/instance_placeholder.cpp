...
bool InstancePlaceholder::_set(const StringName &p_name,
...
Node *
InstancePlaceholder::create_instance(bool p_replace,
                                     const Ref<PackedScene> &p_custom_scene) {
...
void InstancePlaceholder::_bind_methods() {
  ...
  ClassDB::bind_method(D_METHOD("get_stored_values", "with_order"),
                       &InstancePlaceholder::get_stored_values, DEFVAL(false));
  ClassDB::bind_method(D_METHOD("create_instance", "replace", "custom_scene"),
                       &InstancePlaceholder::create_instance, DEFVAL(false),
                       DEFVAL(Variant()));
  ClassDB::bind_method(D_METHOD("get_instance_path"),
