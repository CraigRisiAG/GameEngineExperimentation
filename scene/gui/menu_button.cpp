...
Array MenuButton::_get_items() const { return popup->get("items"); }
...
void MenuButton::_bind_methods() {
  ...
  ClassDB::bind_method(D_METHOD("_unhandled_key_input"),
                       &MenuButton::_unhandled_key_input);
  ClassDB::bind_method(D_METHOD("_set_items"), &MenuButton::_set_items);
  ClassDB::bind_method(D_METHOD("_get_items"), &MenuButton::_get_items);
  ClassDB::bind_method(D_METHOD("set_switch_on_hover", "enable"),
                       &MenuButton::set_switch_on_hover);
  ClassDB::bind_method(D_METHOD("is_switch_on_hover"),
                       &MenuButton::is_switch_on_hover);
  ClassDB::bind_method(D_METHOD("set_disable_shortcuts", "disabled"),
  ...
  ADD_PROPERTY(PropertyInfo(Variant::BOOL, "switch_on_hover"),
               "set_switch_on_hover", "is_switch_on_hover");
...
MenuButton::MenuButton() {
  ...
  popup->connect("about_to_show",
                 ...
                 varray(true)); // For when switching from another MenuButton.
