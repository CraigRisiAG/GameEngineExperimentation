...
void OptionButton::_notification(int p_what) {
  ...
  case NOTIFICATION_DRAW: {
    ...
    Point2 ofs(size.width - arrow->get_width() - get_constant("arrow_margin"),
  ...
  case NOTIFICATION_THEME_CHANGED: {
    ...
    if (has_icon("arrow")) {
      _set_internal_margin(MARGIN_RIGHT,
                           Control::get_icon("arrow")->get_width());
    }
  } break;
...
void OptionButton::add_icon_item(const Ref<Texture2D> &p_icon,
...
void OptionButton::add_separator() { popup->add_separator(); }
...
void OptionButton::remove_item(int p_idx) { popup->remove_item(p_idx); }
...
void OptionButton::_bind_methods() {
  ...
  ClassDB::bind_method(D_METHOD("add_item", "label", "id"),
                       &OptionButton::add_item, DEFVAL(-1));
  ClassDB::bind_method(D_METHOD("add_icon_item", "texture", "label", "id"),
                       &OptionButton::add_icon_item, DEFVAL(-1));
  ClassDB::bind_method(D_METHOD("set_item_text", "idx", "text"),
                       &OptionButton::set_item_text);
  ClassDB::bind_method(D_METHOD("set_item_icon", "idx", "texture"),
  ...
  ClassDB::bind_method(D_METHOD("get_item_id", "idx"),
  ...
  ClassDB::bind_method(D_METHOD("get_selected_metadata"),
                       &OptionButton::get_selected_metadata);
  ClassDB::bind_method(D_METHOD("remove_item", "idx"),
