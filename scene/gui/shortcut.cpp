...
Ref<InputEvent> ShortCut::get_shortcut() const { return shortcut; }
...
bool ShortCut::is_valid() const { return shortcut.is_valid(); }

void ShortCut::_bind_methods() {

  ClassDB::bind_method(D_METHOD("set_shortcut", "event"),
  ...
  ClassDB::bind_method(D_METHOD("is_shortcut", "event"),
