...
public:
  ...
  struct ColorRegion {
    ...
    bool line_only;
    bool eq;
    ColorRegion(const String &p_begin_key = "", const String &p_end_key = "",
...
private:
  ...
  struct TextOperation {
    ...
    enum Type { TYPE_NONE, TYPE_INSERT, TYPE_REMOVE };
  ...
  String _base_get_text(int p_from_line, int p_from_column, int p_to_line,
                        int p_to_column) const;
  void _base_remove_text(int p_from_line, int p_from_column, int p_to_line,
                         int p_to_column);

  int _get_column_pos_of_word(const String &p_key, const String &p_search,
                              uint32_t p_search_flags, int p_from_column);

  Vector<int> _search_bind(const String &p_key, uint32_t p_search_flags,
...
protected:
  ...
  void _insert_text(int p_line, int p_char, const String &p_text,
                    int *r_end_line = NULL, int *r_end_char = NULL);
  void _remove_text(int p_from_line, int p_from_column, int p_to_line,
                    int p_to_column);
...
public:
  ...
  void set_line_info_icon(int p_line, Ref<Texture2D> p_icon,
                          String p_info = "");
  void clear_info_icons();
  ...
  int num_lines_from_rows(int p_line_from, int p_wrap_index_from,
  ...
  void cursor_set_line(int p_row, bool p_adjust_viewport = true,
                       bool p_can_be_hidden = true, int p_wrap_index = 0);
  ...
  void paste();
  void select_all();
  void select(int p_from_line, int p_from_column, int p_to_line,
              int p_to_column);
  void deselect();
  ...
  bool search(const String &p_key, uint32_t p_search_flags, int p_from_line,
              int p_from_column, int &r_line, int &r_column) const;
  ...
  void add_color_region(const String &p_begin_key = String(),
  ...
  void set_tooltip_request_func(Object *p_obj, const StringName &p_function,
                                const Variant &p_udata);

  void set_completion(bool p_enabled, const Vector<String> &p_prefixes);
  void code_complete(const List<ScriptCodeCompletionOption> &p_strings,
                     bool p_forced = false);
...
public:
  ...
  virtual Map<int, TextEdit::HighlighterInfo>
  _get_line_syntax_highlighting(int p_line) = 0;
