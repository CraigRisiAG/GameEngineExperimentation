...
void TreeItem::Cell::draw_icon(const RID &p_where, const Point2 &p_pos,
                               const Size2 &p_size,
  ...
  if (icon_region == Rect2i()) {
    ...
    icon->draw_rect_region(p_where, Rect2(p_pos, dsize),
...
void TreeItem::_changed_notify(int p_cell) { tree->item_changed(p_cell, this); }

void TreeItem::_changed_notify() { tree->item_changed(-1, this); }

void TreeItem::_cell_selected(int p_cell) { tree->item_selected(p_cell, this); }
...
void TreeItem::set_range_config(int p_column, double p_min, double p_max,
                                double p_step, bool p_exp) {
...
void TreeItem::get_range_config(int p_column, double &r_min, double &r_max,
                                double &r_step) const {
...
void TreeItem::set_custom_draw(int p_column, Object *p_object,
...
int TreeItem::get_custom_minimum_height() const { return custom_min_height; }

TreeItem *TreeItem::get_next() { return next; }
...
TreeItem *TreeItem::get_parent() { return parent; }

TreeItem *TreeItem::get_children() { return children; }
...
void TreeItem::add_button(int p_column, const Ref<Texture2D> &p_button,
                          int p_id, bool p_disabled, const String &p_tooltip) {
...
void TreeItem::set_button(int p_column, int p_idx,
                          const Ref<Texture2D> &p_button) {
...
bool TreeItem::is_folding_disabled() const { return disable_folding; }

Variant TreeItem::_call_recursive_bind(const Variant **p_args, int p_argcount,
  ...
  if (p_args[0]->get_type() != Variant::STRING &&
      p_args[0]->get_type() != Variant::STRING_NAME) {
...
void recursive_call_aux(TreeItem *p_item, const StringName &p_method,
...
void TreeItem::call_recursive(const StringName &p_method,
                              const Variant **p_args, int p_argcount,
                              Callable::CallError &r_error) {
...
void TreeItem::_bind_methods() {
  ...
  ClassDB::bind_method(D_METHOD("set_cell_mode", "column", "mode"),
                       &TreeItem::set_cell_mode);
  ClassDB::bind_method(D_METHOD("get_cell_mode", "column"),
                       &TreeItem::get_cell_mode);

  ClassDB::bind_method(D_METHOD("set_checked", "column", "checked"),
                       &TreeItem::set_checked);
  ClassDB::bind_method(D_METHOD("is_checked", "column"), &TreeItem::is_checked);

  ClassDB::bind_method(D_METHOD("set_text", "column", "text"),
                       &TreeItem::set_text);
  ClassDB::bind_method(D_METHOD("get_text", "column"), &TreeItem::get_text);

  ClassDB::bind_method(D_METHOD("set_icon", "column", "texture"),
                       &TreeItem::set_icon);
  ClassDB::bind_method(D_METHOD("get_icon", "column"), &TreeItem::get_icon);

  ClassDB::bind_method(D_METHOD("set_icon_region", "column", "region"),
                       &TreeItem::set_icon_region);
  ClassDB::bind_method(D_METHOD("get_icon_region", "column"),
                       &TreeItem::get_icon_region);

  ClassDB::bind_method(D_METHOD("set_icon_max_width", "column", "width"),
                       &TreeItem::set_icon_max_width);
  ClassDB::bind_method(D_METHOD("get_icon_max_width", "column"),
                       &TreeItem::get_icon_max_width);

  ClassDB::bind_method(D_METHOD("set_icon_modulate", "column", "modulate"),
                       &TreeItem::set_icon_modulate);
  ClassDB::bind_method(D_METHOD("get_icon_modulate", "column"),
                       &TreeItem::get_icon_modulate);

  ClassDB::bind_method(D_METHOD("set_range", "column", "value"),
                       &TreeItem::set_range);
  ...
  ClassDB::bind_method(D_METHOD("get_range_config", "column"),
                       &TreeItem::_get_range_config);

  ClassDB::bind_method(D_METHOD("set_metadata", "column", "meta"),
                       &TreeItem::set_metadata);
  ClassDB::bind_method(D_METHOD("get_metadata", "column"),
  ...
  ClassDB::bind_method(D_METHOD("set_collapsed", "enable"),
                       &TreeItem::set_collapsed);
  ClassDB::bind_method(D_METHOD("is_collapsed"), &TreeItem::is_collapsed);

  ClassDB::bind_method(D_METHOD("set_custom_minimum_height", "height"),
                       &TreeItem::set_custom_minimum_height);
  ClassDB::bind_method(D_METHOD("get_custom_minimum_height"),
  ...
  ClassDB::bind_method(D_METHOD("get_next_visible", "wrap"),
                       &TreeItem::get_next_visible, DEFVAL(false));
  ClassDB::bind_method(D_METHOD("get_prev_visible", "wrap"),
                       &TreeItem::get_prev_visible, DEFVAL(false));

  ClassDB::bind_method(D_METHOD("remove_child", "child"),
                       &TreeItem::_remove_child);

  ClassDB::bind_method(D_METHOD("set_selectable", "column", "selectable"),
                       &TreeItem::set_selectable);
  ClassDB::bind_method(D_METHOD("is_selectable", "column"),
                       &TreeItem::is_selectable);

  ClassDB::bind_method(D_METHOD("is_selected", "column"),
  ...
  ClassDB::bind_method(D_METHOD("set_editable", "column", "enabled"),
                       &TreeItem::set_editable);
  ClassDB::bind_method(D_METHOD("is_editable", "column"),
                       &TreeItem::is_editable);

  ClassDB::bind_method(D_METHOD("set_custom_color", "column", "color"),
                       &TreeItem::set_custom_color);
  ClassDB::bind_method(D_METHOD("clear_custom_color", "column"),
                       &TreeItem::clear_custom_color);
  ClassDB::bind_method(D_METHOD("get_custom_color", "column"),
                       &TreeItem::get_custom_color);

  ClassDB::bind_method(
      D_METHOD("set_custom_bg_color", "column", "color", "just_outline"),
      &TreeItem::set_custom_bg_color, DEFVAL(false));
  ClassDB::bind_method(D_METHOD("clear_custom_bg_color", "column"),
                       &TreeItem::clear_custom_bg_color);
  ClassDB::bind_method(D_METHOD("get_custom_bg_color", "column"),
                       &TreeItem::get_custom_bg_color);

  ClassDB::bind_method(D_METHOD("set_custom_as_button", "column", "enable"),
                       &TreeItem::set_custom_as_button);
  ClassDB::bind_method(D_METHOD("is_custom_set_as_button", "column"),
                       &TreeItem::is_custom_set_as_button);

  ClassDB::bind_method(D_METHOD("add_button", "column", "button", "button_idx",
                                "disabled", "tooltip"),
                       &TreeItem::add_button, DEFVAL(-1), DEFVAL(false),
                       DEFVAL(""));
  ClassDB::bind_method(D_METHOD("get_button_count", "column"),
                       &TreeItem::get_button_count);
  ClassDB::bind_method(D_METHOD("get_button_tooltip", "column", "button_idx"),
                       &TreeItem::get_button_tooltip);
  ClassDB::bind_method(D_METHOD("get_button", "column", "button_idx"),
                       &TreeItem::get_button);
  ClassDB::bind_method(D_METHOD("set_button", "column", "button_idx", "button"),
                       &TreeItem::set_button);
  ClassDB::bind_method(D_METHOD("erase_button", "column", "button_idx"),
                       &TreeItem::erase_button);
  ClassDB::bind_method(
      D_METHOD("set_button_disabled", "column", "button_idx", "disabled"),
      &TreeItem::set_button_disabled);
  ClassDB::bind_method(D_METHOD("is_button_disabled", "column", "button_idx"),
                       &TreeItem::is_button_disabled);

  ClassDB::bind_method(D_METHOD("set_expand_right", "column", "enable"),
                       &TreeItem::set_expand_right);
  ClassDB::bind_method(D_METHOD("get_expand_right", "column"),
                       &TreeItem::get_expand_right);

  ClassDB::bind_method(D_METHOD("set_tooltip", "column", "tooltip"),
                       &TreeItem::set_tooltip);
  ClassDB::bind_method(D_METHOD("get_tooltip", "column"),
                       &TreeItem::get_tooltip);
  ClassDB::bind_method(D_METHOD("set_text_align", "column", "text_align"),
                       &TreeItem::set_text_align);
  ClassDB::bind_method(D_METHOD("get_text_align", "column"),
  ...
  ClassDB::bind_method(D_METHOD("set_disable_folding", "disable"),
                       &TreeItem::set_disable_folding);
  ClassDB::bind_method(D_METHOD("is_folding_disabled"),
...

  {
    ...
    ClassDB::bind_vararg_method(METHOD_FLAGS_DEFAULT, "call_recursive",
                                &TreeItem::_call_recursive_bind, mi);
  }

  ADD_PROPERTY(PropertyInfo(Variant::BOOL, "collapsed"), "set_collapsed",
               "is_collapsed");
  ADD_PROPERTY(PropertyInfo(Variant::BOOL, "disable_folding"),
               "set_disable_folding", "is_folding_disabled");
  ADD_PROPERTY(PropertyInfo(Variant::INT, "custom_minimum_height",
                            PROPERTY_HINT_RANGE, "0,1000,1"),
               "set_custom_minimum_height", "get_custom_minimum_height");
...
void TreeItem::clear_children() {
  ...
  while (c) {
    ...
    c = c->get_next();
    aux->parent =
        0; // so it won't try to recursively autoremove from me in here
    memdelete(aux);
  }
...
void Tree::draw_item_rect(const TreeItem::Cell &p_cell, const Rect2i &p_rect,
                          const Color &p_color, const Color &p_icon_color) {
...
int Tree::draw_item(const Point2i &p_pos, const Point2 &p_draw_ofs,
                    const Size2 &p_draw_size, TreeItem *p_item) {
  ...
  if (!skip && (p_pos.y + label_h - cache.offset.y) > 0) {
    ...
    int ofs = p_pos.x + ((p_item->disable_folding || hide_folding)
                             ? cache.hseparation
                             : cache.item_margin);
    int skip2 = 0;
    for (int i = 0; i < columns.size(); i++) {
      ...
      if (p_item->cells[i].expand_right) {
        ...
        int plus = 1;
        while (i + plus < columns.size() && !p_item->cells[i + plus].editable &&
               p_item->cells[i + plus].mode == TreeItem::CELL_MODE_STRING &&
      ...
      for (int j = p_item->cells[i].buttons.size() - 1; j >= 0; j--) {
        ...
        Point2i o =
            Point2i(ofs + w - s.width, p_pos.y) - cache.offset + p_draw_ofs;

        if (cache.click_type == Cache::CLICK_BUTTON &&
            cache.click_item == p_item && cache.click_column == i &&
            cache.click_index == j && !p_item->cells[i].buttons[j].disabled) {
          // being pressed
      ...
      Rect2i item_rect =
          Rect2i(Point2i(ofs, p_pos.y) - cache.offset + p_draw_ofs,
                 Size2i(w, label_h));
      ...
      if (cache.draw_guides) {
        VisualServer::get_singleton()->canvas_item_add_line(
            ci,
            Point2i(cell_rect.position.x,
                    cell_rect.position.y + cell_rect.size.height),
            cell_rect.position + cell_rect.size, cache.guide_color, 1);
      }
      ...
      if (i == 0) {
        ...
        if (p_item->cells[0].selected && select_mode == SELECT_ROW) {
          Rect2i row_rect = Rect2i(
              Point2i(cache.bg->get_margin(MARGIN_LEFT), item_rect.position.y),
              Size2i(get_size().width - cache.bg->get_minimum_size().width,
                     item_rect.size.y));
      ...
      if (p_item->cells[i].custom_bg_color) {
        ...
        if (p_item->cells[i].custom_bg_outline) {
          VisualServer::get_singleton()->canvas_item_add_rect(
              ci, Rect2(r.position.x, r.position.y, r.size.x, 1),
              p_item->cells[i].bg_color);
          VisualServer::get_singleton()->canvas_item_add_rect(
              ci, Rect2(r.position.x, r.position.y + r.size.y - 1, r.size.x, 1),
              p_item->cells[i].bg_color);
          VisualServer::get_singleton()->canvas_item_add_rect(
              ci, Rect2(r.position.x, r.position.y, 1, r.size.y),
              p_item->cells[i].bg_color);
          VisualServer::get_singleton()->canvas_item_add_rect(
              ci, Rect2(r.position.x + r.size.x - 1, r.position.y, 1, r.size.y),
              p_item->cells[i].bg_color);
        } else {
          VisualServer::get_singleton()->canvas_item_add_rect(
              ci, r, p_item->cells[i].bg_color);
        }
      }
      ...
      if (drop_mode_flags && drop_mode_over == p_item) {
        ...
        if (drop_mode_section == 1 || drop_mode_section == 0) {
          VisualServer::get_singleton()->canvas_item_add_rect(
              ci, Rect2(r.position.x, r.position.y + r.size.y, r.size.x, 1),
              cache.drop_position_color);
        }
      }
      ...
      Color col =
          p_item->cells[i].custom_color
              ...
              : get_color(p_item->cells[i].selected ? "font_color_selected"
                                                    : "font_color");
      Color icon_col = p_item->cells[i].icon_color;

      Point2i text_pos = item_rect.position;
      text_pos.y += Math::floor((item_rect.size.y - font->get_height()) / 2) +
                    font_ascent;
      ...
      case TreeItem::CELL_MODE_CHECK: {
        ...
        check_ofs.y +=
            Math::floor((real_t)(item_rect.size.y - checked->get_height()) / 2);
      ...
      case TreeItem::CELL_MODE_RANGE: {
        if (p_item->cells[i].text != "") {
          ...
          updown_pos.y +=
              Math::floor(((item_rect.size.y - updown->get_height())) / 2.0);
      ...
      case TreeItem::CELL_MODE_ICON: {
        ...
        if (p_item->cells[i].icon_max_w > 0 &&
          ...
          icon_size.height =
              icon_size.height * p_item->cells[i].icon_max_w / icon_size.width;
          icon_size.width = p_item->cells[i].icon_max_w;
        }
      ...
      case TreeItem::CELL_MODE_CUSTOM: {
        ...
        if (p_item->cells[i].custom_draw_obj.is_valid()) {
          ...
          Object *cdo =
              ObjectDB::get_instance(p_item->cells[i].custom_draw_obj);
          if (cdo)
            cdo->call(p_item->cells[i].custom_draw_callback, p_item,
                      Rect2(item_rect));
        }
    ...
    if (!p_item->disable_folding && !hide_folding &&
      ...
      arrow->draw(ci, p_pos + p_draw_ofs +
  ...
  if (!p_item->collapsed) { /* if not collapsed, check the children */
    ...
    while (c) {
      ...
      if (cache.draw_relationship_lines > 0 &&
        ...
        int root_ofs =
            children_pos.x + ((p_item->disable_folding || hide_folding)
                                  ? cache.hseparation
                                  : cache.item_margin);
        int parent_ofs = p_pos.x + ((p_item->disable_folding || hide_folding)
                                        ? cache.hseparation
                                        : cache.item_margin);
        Point2i root_pos = Point2i(root_ofs, children_pos.y + label_h / 2) -
        ...
        Point2i parent_pos =
            Point2i(parent_ofs - cache.arrow->get_width() / 2,
                    p_pos.y + label_h / 2 + cache.arrow->get_height() / 2) -
            cache.offset + p_draw_ofs;

        if (root_pos.y + line_width >= 0) {
          VisualServer::get_singleton()->canvas_item_add_line(
              ci, root_pos,
              Point2i(parent_pos.x - Math::floor(line_width / 2), root_pos.y),
              cache.relationship_line_color, line_width);
          VisualServer::get_singleton()->canvas_item_add_line(
              ci, Point2i(parent_pos.x, root_pos.y),
              Point2i(parent_pos.x, prev_ofs), cache.relationship_line_color,
              line_width);
        }
...
void Tree::select_single_item(TreeItem *p_selected, TreeItem *p_current,
                              int p_col, TreeItem *p_prev, bool *r_in_range,
...
void Tree::_range_click_timeout() {
  ...
  if (range_item_last && !range_drag_enabled &&
    ...
    propagate_mouse_activated =
        false; // done from outside, so signal handler can't clear the tree in
               // the middle of emit (which is a common case)
    blocked++;
    propagate_mouse_event(pos + cache.offset, 0, 0, false, root, BUTTON_LEFT,
                          mb);
    blocked--;
...
int Tree::propagate_mouse_event(const Point2i &p_pos, int x_ofs, int y_ofs,
                                bool p_doubleclick, TreeItem *p_item,
                                int p_button,
  ...
  if (!skip && p_pos.y < item_h) {
    ...
    for (int j = c.buttons.size() - 1; j >= 0; j--) {
      ...
      int w =
          b->get_size().width + cache.button_pressed->get_minimum_size().width;
    ...
    if (p_button == BUTTON_LEFT ||
      ...
      if (p_doubleclick &&
          (!c.editable || c.mode == TreeItem::CELL_MODE_CUSTOM ||
           c.mode ==
               TreeItem::
                   CELL_MODE_ICON /*|| c.mode==TreeItem::CELL_MODE_CHECK*/)) { // it's confusing for check
    ...
    case TreeItem::CELL_MODE_STRING: {
      ...
      if (select_mode == SELECT_MULTI &&
          (get_tree()->get_event_count() == focus_in_id || !already_cursor)) {
    ...
    case TreeItem::CELL_MODE_RANGE: {
      if (c.text != "") {
        ...
        for (int i = 0; i < c.text.get_slice_count(","); i++) {
          ...
          popup_menu->add_item(
              s.get_slicec(':', 0),
              s.get_slicec(':', 1).empty() ? i : s.get_slicec(':', 1).to_int());
        }
        ...
        if (x >= (col_width - item_h / 2)) {
          ...
          editor_text =
              String::num(p_item->cells[col].val,
    ...
    pressing_item_rect = Rect2(
        get_global_position() +
            Point2i(col_ofs, _get_title_button_height() + y_ofs) - cache.offset,
    ...
    if (!p_item->collapsed) { /* if not collapsed, check the children */
      ...
      while (c) {
        ...
        int child_h = propagate_mouse_event(new_pos, x_ofs, y_ofs,
                                            p_doubleclick, c, p_button, p_mod);
...
void Tree::_gui_input(Ref<InputEvent> p_event) {
  ...
  if (b.is_valid()) {
    ...
    if (!b->is_pressed()) {
      ...
      if (b->get_button_index() == BUTTON_LEFT) {
        ...
        if (single_select_defer) {
          select_single_item(single_select_defer, root,
        ...
        if (cache.click_type == Cache::CLICK_BUTTON &&
          ...
          // make sure in case of wrong reference after reconstructing whole
          // TreeItems
          cache.click_item = get_item_at_position(cache.click_pos);
          emit_signal("button_pressed", cache.click_item, cache.click_column,
                      cache.click_id);
        }
        cache.click_type = Cache::CLICK_NONE;
        cache.click_index = -1;
    ...
    case BUTTON_LEFT: {
      ...
      blocked++;
      propagate_mouse_event(pos + cache.offset, 0, 0, b->is_doubleclick(), root,
                            b->get_button_index(), b);
      blocked--;
      ...
      if (!click_handled) {
        ...
        if (b->get_button_index() == BUTTON_LEFT) {
          if (get_item_at_position(b->get_position()) == NULL &&
              !b->get_shift() && !b->get_control() && !b->get_command())
    ...
    case BUTTON_WHEEL_UP: {
      ...
      v_scroll->set_value(v_scroll->get_value() -
...
bool Tree::edit_selected() {
  ...
  if (c.mode == TreeItem::CELL_MODE_CHECK) {
    ...
    for (int i = 0; i < c.text.get_slice_count(","); i++) {
      ...
      popup_menu->add_item(
          s2.get_slicec(':', 0),
          s2.get_slicec(':', 1).empty() ? i : s2.get_slicec(':', 1).to_int());
    }

    popup_menu->set_size(Size2(rect.size.width, 0));
    popup_menu->set_position(get_global_position() + rect.position +
                             Point2i(0, rect.size.height));
    popup_menu->popup();
    popup_edited_item = s;
    popup_edited_item_col = col;
    return true;
    ...
    if (c.mode == TreeItem::CELL_MODE_RANGE) {
      ...
      value_editor->set_position(textedpos +
                                 Point2i(0, text_editor->get_size().height));
...
void Tree::update_scrollbars() {
  ...
  v_scroll->set_end(
      Point2(size.width, size.height - cache.bg->get_margin(MARGIN_TOP) -
...
int Tree::_get_title_button_height() const {
  ...
  return show_column_titles ? cache.font->get_height() +
...
void Tree::_notification(int p_what) {
  ...
  if (p_what == NOTIFICATION_INTERNAL_PHYSICS_PROCESS) {
    ...
    if (scrolling &&
      ...
      if ((ABS(mouse_position.x) < ABS(mouse_position.x - get_size().width)) &&
      ...
      if ((ABS(mouse_position.y) < ABS(mouse_position.y - get_size().height)) &&
  ...
  if (p_what == NOTIFICATION_DRAW) {
    ...
    if (show_column_titles) {
      ...
      for (int i = 0; i < columns.size(); i++) {
        ...
        Ref<StyleBox> sb =
            (cache.click_type == Cache::CLICK_TITLE && cache.click_index == i)
        ...
        Rect2 tbrect = Rect2(ofs2 - cache.offset.x, bg->get_margin(MARGIN_TOP),
                             get_column_width(i), tbh);
        sb->draw(ci, tbrect);
        ...
        f->draw_halign(ci,
                       tbrect.position +
                           Point2i(sb->get_offset().x,
                                   (tbrect.size.height - f->get_height()) / 2 +
                                       f->get_ascent()),
                       HALIGN_CENTER, clip_w, columns[i].title,
...
Size2 Tree::get_minimum_size() const { return Size2(1, 1); }
...
TreeItem *Tree::get_root() { return root; }
...
void Tree::item_changed(int p_column, TreeItem *p_item) { update(); }
...
bool Tree::is_anything_selected() { return (selected_item != NULL); }
...
bool Tree::is_root_hidden() const { return hide_root; }
...
TreeItem *Tree::get_selected() const { return selected_item; }

int Tree::get_selected_column() const { return selected_col; }

TreeItem *Tree::get_edited() const { return edited_item; }

int Tree::get_edited_column() const { return edited_col; }
...
int Tree::get_column_width(int p_column) const {
  ...
  int expand_area = get_size().width - (bg->get_margin(MARGIN_LEFT) +
                                        bg->get_margin(MARGIN_RIGHT));
...
int Tree::get_columns() const { return columns.size(); }

void Tree::_scroll_moved(float) { update(); }

Rect2 Tree::get_custom_popup_rect() const { return custom_popup_rect; }
...
void Tree::ensure_cursor_is_visible() {
  ...
  if (y_offset != -1) {
    ...
    const int screen_h =
        area_size.height - h_scroll->get_combined_minimum_size().height - tbh;

    if (cell_h >
        screen_h) { // Screen size is too small, maybe it was not resized yet.
...
int Tree::get_pressed_button() const { return pressed_button; }
...
bool Tree::are_column_titles_visible() const { return show_column_titles; }
...
void Tree::scroll_to_item(TreeItem *p_item) {
  ...
  if (r.position.y < v_scroll->get_value()) {
    ...
    v_scroll->set_value(r.position.y + r.size.y + 2 * cache.vseparation -
                        get_size().y);
  }
}

TreeItem *Tree::_search_item_text(TreeItem *p_at, const String &p_find,
                                  int *r_col, bool p_selectable,
                                  bool p_backwards) {
...
TreeItem *Tree::search_item_text(const String &p_find, int *r_col,
                                 bool p_selectable) {
  ...
  return _search_item_text(from->get_next_visible(true), p_find, r_col,
                           p_selectable);
}
...
TreeItem *Tree::_find_item_at_pos(TreeItem *p_item, const Point2 &p_pos,
                                  int &r_column, int &h, int &section) const {
...
bool Tree::can_cursor_exit_tree() const { return cursor_can_exit_tree; }
...
bool Tree::is_folding_hidden() const { return hide_folding; }
...
int Tree::get_drop_mode_flags() const { return drop_mode_flags; }
...
void Tree::set_allow_rmb_select(bool p_allow) { allow_rmb_select = p_allow; }

bool Tree::get_allow_rmb_select() const { return allow_rmb_select; }

void Tree::set_allow_reselect(bool p_allow) { allow_reselect = p_allow; }

bool Tree::get_allow_reselect() const { return allow_reselect; }
...
void Tree::_bind_methods() {
  ...
  ClassDB::bind_method(D_METHOD("create_item", "parent", "idx"),
                       &Tree::_create_item, DEFVAL(Variant()), DEFVAL(-1));

  ClassDB::bind_method(D_METHOD("get_root"), &Tree::get_root);
  ClassDB::bind_method(D_METHOD("set_column_min_width", "column", "min_width"),
                       &Tree::set_column_min_width);
  ClassDB::bind_method(D_METHOD("set_column_expand", "column", "expand"),
                       &Tree::set_column_expand);
  ClassDB::bind_method(D_METHOD("get_column_width", "column"),
  ...
  ClassDB::bind_method(D_METHOD("get_next_selected", "from"),
                       &Tree::_get_next_selected);
  ClassDB::bind_method(D_METHOD("get_selected"), &Tree::get_selected);
  ClassDB::bind_method(D_METHOD("get_selected_column"),
                       &Tree::get_selected_column);
  ClassDB::bind_method(D_METHOD("get_pressed_button"),
                       &Tree::get_pressed_button);
  ClassDB::bind_method(D_METHOD("set_select_mode", "mode"),
  ...
  ClassDB::bind_method(D_METHOD("get_custom_popup_rect"),
                       &Tree::get_custom_popup_rect);
  ClassDB::bind_method(D_METHOD("get_item_area_rect", "item", "column"),
                       &Tree::_get_item_rect, DEFVAL(-1));
  ClassDB::bind_method(D_METHOD("get_item_at_position", "position"),
                       &Tree::get_item_at_position);
  ClassDB::bind_method(D_METHOD("get_column_at_position", "position"),
                       &Tree::get_column_at_position);
  ClassDB::bind_method(D_METHOD("get_drop_section_at_position", "position"),
                       &Tree::get_drop_section_at_position);

  ClassDB::bind_method(D_METHOD("ensure_cursor_is_visible"),
                       &Tree::ensure_cursor_is_visible);

  ClassDB::bind_method(D_METHOD("set_column_titles_visible", "visible"),
                       &Tree::set_column_titles_visible);
  ClassDB::bind_method(D_METHOD("are_column_titles_visible"),
                       &Tree::are_column_titles_visible);

  ClassDB::bind_method(D_METHOD("set_column_title", "column", "title"),
                       &Tree::set_column_title);
  ClassDB::bind_method(D_METHOD("get_column_title", "column"),
                       &Tree::get_column_title);
  ClassDB::bind_method(D_METHOD("get_scroll"), &Tree::get_scroll);

  ClassDB::bind_method(D_METHOD("set_hide_folding", "hide"),
                       &Tree::set_hide_folding);
  ClassDB::bind_method(D_METHOD("is_folding_hidden"), &Tree::is_folding_hidden);

  ClassDB::bind_method(D_METHOD("set_drop_mode_flags", "flags"),
                       &Tree::set_drop_mode_flags);
  ClassDB::bind_method(D_METHOD("get_drop_mode_flags"),
                       &Tree::get_drop_mode_flags);

  ClassDB::bind_method(D_METHOD("set_allow_rmb_select", "allow"),
                       &Tree::set_allow_rmb_select);
  ClassDB::bind_method(D_METHOD("get_allow_rmb_select"),
                       &Tree::get_allow_rmb_select);

  ClassDB::bind_method(D_METHOD("set_allow_reselect", "allow"),
                       &Tree::set_allow_reselect);
  ClassDB::bind_method(D_METHOD("get_allow_reselect"),
                       &Tree::get_allow_reselect);

  ADD_PROPERTY(PropertyInfo(Variant::INT, "columns"), "set_columns",
               "get_columns");
  ADD_PROPERTY(PropertyInfo(Variant::BOOL, "allow_reselect"),
               "set_allow_reselect", "get_allow_reselect");
  ADD_PROPERTY(PropertyInfo(Variant::BOOL, "allow_rmb_select"),
               "set_allow_rmb_select", "get_allow_rmb_select");
  ADD_PROPERTY(PropertyInfo(Variant::BOOL, "hide_folding"), "set_hide_folding",
               "is_folding_hidden");
  ADD_PROPERTY(PropertyInfo(Variant::BOOL, "hide_root"), "set_hide_root",
               "is_root_hidden");
  ADD_PROPERTY(PropertyInfo(Variant::INT, "drop_mode_flags",
                            PROPERTY_HINT_FLAGS, "On Item,In between"),
               "set_drop_mode_flags", "get_drop_mode_flags");
  ADD_PROPERTY(PropertyInfo(Variant::INT, "select_mode", PROPERTY_HINT_ENUM,
                            "Single,Row,Multi"),
               "set_select_mode", "get_select_mode");

  ADD_SIGNAL(MethodInfo("item_selected"));
  ADD_SIGNAL(MethodInfo("cell_selected"));
  ADD_SIGNAL(MethodInfo("multi_selected",
                        PropertyInfo(Variant::OBJECT, "item",
                                     PROPERTY_HINT_RESOURCE_TYPE, "TreeItem"),
                        PropertyInfo(Variant::INT, "column"),
                        PropertyInfo(Variant::BOOL, "selected")));
  ADD_SIGNAL(MethodInfo("item_rmb_selected",
                        PropertyInfo(Variant::VECTOR2, "position")));
  ADD_SIGNAL(
      MethodInfo("empty_rmb", PropertyInfo(Variant::VECTOR2, "position")));
  ADD_SIGNAL(MethodInfo("empty_tree_rmb_selected",
                        PropertyInfo(Variant::VECTOR2, "position")));
  ...
  ADD_SIGNAL(MethodInfo("custom_popup_edited",
...
Tree::Tree() {
  ...
  range_click_timer->connect("timeout",
  ...
  text_editor->connect("text_entered",
                       callable_mp(this, &Tree::text_editor_enter));
  text_editor->connect("modal_closed",
                       callable_mp(this, &Tree::_text_editor_modal_close));
  popup_menu->connect("id_pressed", callable_mp(this, &Tree::popup_select));
  value_editor->connect("value_changed",
                        callable_mp(this, &Tree::value_editor_changed));
