...
/**
        ...
        The positional tracker object as an object that represents the position
   and orientation of a tracked object like a controller or headset. An AR/VR
...
private:
  ...
  real_t
      rumble; // rumble strength, 0.0 is off, 1.0 is maximum, note that we only
              // record here, arvr_interface is responsible for execution
...
public:
  ...
  void set_position(
      const Vector3 &p_position); // set position with world_scale applied
