...
public:
  enum FeedDataType {
    ...
    FEED_RGB, // our texture will contain a normal RGB texture that can be used
              // directly
...
protected:
  ...
  bool active; // only when active do we actually update the camera texture each
               // frame
