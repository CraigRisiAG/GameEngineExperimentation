...
void AudioEffectStereoEnhanceInstance::process(const AudioFrame *p_src_frames,
  ...
  for (int i = 0; i < p_frame_count; i++) {
    ...
    if (surround_mode) {
      ...
      float out =
          delay_ringbuff[(ringbuff_pos - delay_frames) & ringbuff_mask] *
          surround_amount;
...
Ref<AudioEffectInstance> AudioEffectStereoEnhance::instance() {
  ...
  float ring_buffer_max_size =
      AudioEffectStereoEnhanceInstance::MAX_DELAY_MS + 2;
...
float AudioEffectStereoEnhance::get_pan_pullout() const { return pan_pullout; }
...
void AudioEffectStereoEnhance::_bind_methods() {
  ...
  ClassDB::bind_method(D_METHOD("set_pan_pullout", "amount"),
                       &AudioEffectStereoEnhance::set_pan_pullout);
  ClassDB::bind_method(D_METHOD("get_pan_pullout"),
                       &AudioEffectStereoEnhance::get_pan_pullout);

  ClassDB::bind_method(D_METHOD("set_time_pullout", "amount"),
                       &AudioEffectStereoEnhance::set_time_pullout);
  ClassDB::bind_method(D_METHOD("get_time_pullout"),
                       &AudioEffectStereoEnhance::get_time_pullout);

  ClassDB::bind_method(D_METHOD("set_surround", "amount"),
                       &AudioEffectStereoEnhance::set_surround);
  ClassDB::bind_method(D_METHOD("get_surround"),
                       &AudioEffectStereoEnhance::get_surround);

  ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "pan_pullout", PROPERTY_HINT_RANGE,
                            "0,4,0.01"),
               "set_pan_pullout", "get_pan_pullout");
  ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "time_pullout_ms",
                            PROPERTY_HINT_RANGE, "0,50,0.01"),
               "set_time_pullout", "get_time_pullout");
  ADD_PROPERTY(
      PropertyInfo(Variant::FLOAT, "surround", PROPERTY_HINT_RANGE, "0,1,0.01"),
      "set_surround", "get_surround");
}
