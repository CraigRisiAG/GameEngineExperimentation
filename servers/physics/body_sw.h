...
class BodySW : public CollisionObjectSW {
  ...
  _FORCE_INLINE_ void
  _compute_area_gravity_and_dampenings(const AreaSW *p_area);
...
public:
  void set_force_integration_callback(ObjectID p_id, const StringName &p_method,
  ...
  _FORCE_INLINE_ void
  add_contact(const Vector3 &p_local_pos, const Vector3 &p_local_normal,
              real_t p_depth, int p_local_shape, const Vector3 &p_collider_pos,
              int p_collider_shape, ObjectID p_collider_instance_id,
              const RID &p_collider, const Vector3 &p_collider_velocity_at_pos);
  ...
  _FORCE_INLINE_ void
  set_omit_force_integration(bool p_omit_force_integration) {
  ...
  _FORCE_INLINE_ void apply_bias_impulse(const Vector3 &p_pos,
                                         const Vector3 &p_j,
...
void BodySW::add_contact(const Vector3 &p_local_pos,
                         const Vector3 &p_local_normal, real_t p_depth,
                         int p_local_shape, const Vector3 &p_collider_pos,
                         int p_collider_shape, ObjectID p_collider_instance_id,
...
public:
  ...
  virtual Vector3
  get_contact_collider_velocity_at_position(int p_contact_idx) const {
    ERR_FAIL_INDEX_V(p_contact_idx, body->contact_count, Vector3());
