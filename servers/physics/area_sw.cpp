...
AreaSW::BodyKey::BodyKey(BodySW *p_body, uint32_t p_body_shape,
...
AreaSW::BodyKey::BodyKey(AreaSW *p_body, uint32_t p_body_shape,
                         uint32_t p_area_shape) {
  rid = p_body->get_self();
  instance_id = p_body->get_instance_id();
  body_shape = p_body_shape;
...
void AreaSW::set_area_monitor_callback(ObjectID p_id,
...
void AreaSW::set_space_override_mode(
...
void AreaSW::set_param(PhysicsServer::AreaParameter p_param,
