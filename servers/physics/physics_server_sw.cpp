...
RID PhysicsServerSW::shape_create(ShapeType p_shape) {
  ...
  case SHAPE_CYLINDER: {
    ...
    ERR_FAIL_V_MSG(RID(), "CylinderShape is not supported in GodotPhysics. "
                          "Please switch to Bullet in the Project Settings.");
  } break;
...
real_t PhysicsServerSW::shape_get_margin(RID p_shape) const { return 0.0; }
...
void PhysicsServerSW::space_set_param(RID p_space, SpaceParameter p_param,
                                      real_t p_value) {
...
real_t PhysicsServerSW::space_get_param(RID p_space,
                                        SpaceParameter p_param) const {
...
PhysicsDirectSpaceState *PhysicsServerSW::space_get_direct_state(RID p_space) {
  ...
  ERR_FAIL_COND_V_MSG(!doing_sync || space->is_locked(), NULL,
                      "Space state is inaccessible right now, wait for "
                      "iteration or physics process notification.");

  return space->get_direct_state();
}

void PhysicsServerSW::space_set_debug_contacts(RID p_space,
                                               int p_max_contacts) {
...
void PhysicsServerSW::area_set_space_override_mode(
...
PhysicsServer::AreaSpaceOverrideMode
PhysicsServerSW::area_get_space_override_mode(RID p_area) const {
...
void PhysicsServerSW::area_add_shape(RID p_area, RID p_shape,
...
void PhysicsServerSW::area_set_shape_transform(RID p_area, int p_shape_idx,
                                               const Transform &p_transform) {
...
Transform PhysicsServerSW::area_get_shape_transform(RID p_area,
                                                    int p_shape_idx) const {
...
void PhysicsServerSW::area_set_shape_disabled(RID p_area, int p_shape_idx,
                                              bool p_disabled) {
...
void PhysicsServerSW::area_attach_object_instance_id(RID p_area,
                                                     ObjectID p_id) {
...
void PhysicsServerSW::area_set_param(RID p_area, AreaParameter p_param,
...
void PhysicsServerSW::area_set_transform(RID p_area,
                                         const Transform &p_transform) {
...
Variant PhysicsServerSW::area_get_param(RID p_area,
                                        AreaParameter p_param) const {
...
void PhysicsServerSW::area_set_monitor_callback(RID p_area, Object *p_receiver,
  ...
  area->set_monitor_callback(
      p_receiver ? p_receiver->get_instance_id() : ObjectID(), p_method);
}
...
void PhysicsServerSW::area_set_area_monitor_callback(
    RID p_area, Object *p_receiver, const StringName &p_method) {
...
void PhysicsServerSW::body_add_shape(RID p_body, RID p_shape,
                                     const Transform &p_transform,
                                     bool p_disabled) {
...
void PhysicsServerSW::body_set_shape_transform(RID p_body, int p_shape_idx,
                                               const Transform &p_transform) {
...
void PhysicsServerSW::body_set_shape_disabled(RID p_body, int p_shape_idx,
                                              bool p_disabled) {
...
Transform PhysicsServerSW::body_get_shape_transform(RID p_body,
                                                    int p_shape_idx) const {
...
void PhysicsServerSW::body_set_enable_continuous_collision_detection(
    RID p_body, bool p_enable) {
...
bool PhysicsServerSW::body_is_continuous_collision_detection_enabled(
    RID p_body) const {
...
void PhysicsServerSW::body_attach_object_instance_id(RID p_body,
                                                     ObjectID p_id) {
...
void PhysicsServerSW::body_set_param(RID p_body, BodyParameter p_param,
                                     real_t p_value) {
...
real_t PhysicsServerSW::body_get_param(RID p_body,
                                       BodyParameter p_param) const {
...
void PhysicsServerSW::body_set_kinematic_safe_margin(RID p_body,
                                                     real_t p_margin) {
  BodySW *body = body_owner.getornull(p_body);
  ERR_FAIL_COND(!body);
...
void PhysicsServerSW::body_set_state(RID p_body, BodyState p_state,
...
void PhysicsServerSW::body_set_applied_force(RID p_body,
...
void PhysicsServerSW::body_set_applied_torque(RID p_body,
...
void PhysicsServerSW::body_add_central_force(RID p_body,
                                             const Vector3 &p_force) {
  BodySW *body = body_owner.getornull(p_body);
  ERR_FAIL_COND(!body);
...
void PhysicsServerSW::body_add_force(RID p_body, const Vector3 &p_force,
                                     const Vector3 &p_pos) {
  BodySW *body = body_owner.getornull(p_body);
  ERR_FAIL_COND(!body);
...
void PhysicsServerSW::body_apply_central_impulse(RID p_body,
...
void PhysicsServerSW::body_apply_impulse(RID p_body, const Vector3 &p_pos,
                                         const Vector3 &p_impulse) {
...
void PhysicsServerSW::body_apply_torque_impulse(RID p_body,
                                                const Vector3 &p_impulse) {
...
void PhysicsServerSW::body_set_axis_velocity(RID p_body,
...
void PhysicsServerSW::body_set_axis_lock(RID p_body, BodyAxis p_axis,
                                         bool p_lock) {
...
void PhysicsServerSW::body_remove_collision_exception(RID p_body,
                                                      RID p_body_b) {
...
void PhysicsServerSW::body_get_collision_exceptions(RID p_body,
...
void PhysicsServerSW::body_set_contacts_reported_depth_threshold(
    RID p_body, real_t p_threshold) {
...
real_t
PhysicsServerSW::body_get_contacts_reported_depth_threshold(RID p_body) const {
...
void PhysicsServerSW::body_set_max_contacts_reported(RID p_body,
                                                     int p_contacts) {
...
void PhysicsServerSW::body_set_force_integration_callback(
    RID p_body, Object *p_receiver, const StringName &p_method,
...
bool PhysicsServerSW::body_test_motion(RID p_body, const Transform &p_from,
  ...
  return body->get_space()->test_body_motion(
      body, p_from, p_motion, p_infinite_inertia, body->get_kinematic_margin(),
      r_result, p_exclude_raycast_shapes);
}

int PhysicsServerSW::body_test_ray_separation(
    RID p_body, const Transform &p_transform, bool p_infinite_inertia,
    Vector3 &r_recover_motion, SeparationResult *r_results, int p_result_max,
    float p_margin) {
  ...
  return body->get_space()->test_body_ray_separation(
      body, p_transform, p_infinite_inertia, r_recover_motion, r_results,
      p_result_max, p_margin);
}
...
PhysicsDirectBodyState *PhysicsServerSW::body_get_direct_state(RID p_body) {
  ...
  ERR_FAIL_COND_V_MSG(!doing_sync || body->get_space()->is_locked(), NULL,
                      "Body state is inaccessible right now, wait for "
                      "iteration or physics process notification.");
...
RID PhysicsServerSW::joint_create_pin(RID p_body_A, const Vector3 &p_local_A,
                                      RID p_body_B, const Vector3 &p_local_B) {
...
void PhysicsServerSW::pin_joint_set_param(RID p_joint, PinJointParam p_param,
                                          real_t p_value) {
...
real_t PhysicsServerSW::pin_joint_get_param(RID p_joint,
                                            PinJointParam p_param) const {
...
RID PhysicsServerSW::joint_create_hinge(RID p_body_A,
...
RID PhysicsServerSW::joint_create_hinge_simple(
    RID p_body_A, const Vector3 &p_pivot_A, const Vector3 &p_axis_A,
    RID p_body_B, const Vector3 &p_pivot_B, const Vector3 &p_axis_B) {
  ...
  JointSW *joint = memnew(
      HingeJointSW(body_A, body_B, p_pivot_A, p_pivot_B, p_axis_A, p_axis_B));
  RID rid = joint_owner.make_rid(joint);
  joint->set_self(rid);
  return rid;
}

void PhysicsServerSW::hinge_joint_set_param(RID p_joint,
...
real_t PhysicsServerSW::hinge_joint_get_param(RID p_joint,
                                              HingeJointParam p_param) const {
...
void PhysicsServerSW::hinge_joint_set_flag(RID p_joint, HingeJointFlag p_flag,
                                           bool p_value) {
...
bool PhysicsServerSW::hinge_joint_get_flag(RID p_joint,
                                           HingeJointFlag p_flag) const {
...
void PhysicsServerSW::joint_disable_collisions_between_bodies(
    RID p_joint, const bool p_disable) {
  JointSW *joint = joint_owner.getornull(p_joint);
  ERR_FAIL_COND(!joint);
...
bool PhysicsServerSW::joint_is_disabled_collisions_between_bodies(
    RID p_joint) const {
  JointSW *joint = joint_owner.getornull(p_joint);
...
RID PhysicsServerSW::joint_create_slider(RID p_body_A,
  ...
  JointSW *joint =
      memnew(SliderJointSW(body_A, body_B, p_local_frame_A, p_local_frame_B));
  RID rid = joint_owner.make_rid(joint);
  joint->set_self(rid);
  return rid;
}

void PhysicsServerSW::slider_joint_set_param(RID p_joint,
...
real_t PhysicsServerSW::slider_joint_get_param(RID p_joint,
                                               SliderJointParam p_param) const {
...
RID PhysicsServerSW::joint_create_cone_twist(RID p_body_A,
                                             const Transform &p_local_frame_A,
                                             RID p_body_B,
                                             const Transform &p_local_frame_B) {
  ...
  JointSW *joint = memnew(
      ConeTwistJointSW(body_A, body_B, p_local_frame_A, p_local_frame_B));
  RID rid = joint_owner.make_rid(joint);
  joint->set_self(rid);
  return rid;
}

void PhysicsServerSW::cone_twist_joint_set_param(RID p_joint,
...
real_t
PhysicsServerSW::cone_twist_joint_get_param(RID p_joint,
                                            ConeTwistJointParam p_param) const {
...
RID PhysicsServerSW::joint_create_generic_6dof(
    RID p_body_A, const Transform &p_local_frame_A, RID p_body_B,
    const Transform &p_local_frame_B) {
  ...
  JointSW *joint = memnew(Generic6DOFJointSW(body_A, body_B, p_local_frame_A,
                                             p_local_frame_B, true));
  RID rid = joint_owner.make_rid(joint);
  joint->set_self(rid);
  return rid;
}

void PhysicsServerSW::generic_6dof_joint_set_param(RID p_joint,
                                                   Vector3::Axis p_axis,
  ...
  Generic6DOFJointSW *generic_6dof_joint =
      static_cast<Generic6DOFJointSW *>(joint);
  generic_6dof_joint->set_param(p_axis, p_param, p_value);
}
real_t
PhysicsServerSW::generic_6dof_joint_get_param(RID p_joint, Vector3::Axis p_axis,
                                              G6DOFJointAxisParam p_param) {
  ...
  if (shape_owner.owns(p_rid)) {
    ...
    */
    ...
    while (space->get_objects().size()) {
      CollisionObjectSW *co =
          (CollisionObjectSW *)space->get_objects().front()->get();
      co->set_space(NULL);
    }
...
void PhysicsServerSW::set_active(bool p_active) { active = p_active; };
...
void PhysicsServerSW::flush_queries() {
  ...
  if (EngineDebugger::is_profiling("servers")) {
    ...
    static const char *time_name[SpaceSW::ELAPSED_TIME_MAX] = {
        ...
        "solve_constraints", "integrate_velocities"};
...
void PhysicsServerSW::_shape_col_cbk(const Vector3 &p_point_A,
