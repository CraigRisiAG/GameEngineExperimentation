...
public:
  ...
  _FORCE_INLINE_ void add_body_to_query(BodySW *p_body, uint32_t p_body_shape,
                                        uint32_t p_area_shape);
  _FORCE_INLINE_ void remove_body_from_query(BodySW *p_body,
                                             uint32_t p_body_shape,
                                             uint32_t p_area_shape);

  _FORCE_INLINE_ void add_area_to_query(AreaSW *p_area, uint32_t p_area_shape,
                                        uint32_t p_self_shape);
  _FORCE_INLINE_ void remove_area_from_query(AreaSW *p_area,
                                             uint32_t p_area_shape,
                                             uint32_t p_self_shape);
...
void AreaSW::add_body_to_query(BodySW *p_body, uint32_t p_body_shape,
                               uint32_t p_area_shape) {
...
void AreaSW::remove_body_from_query(BodySW *p_body, uint32_t p_body_shape,
                                    uint32_t p_area_shape) {
...
void AreaSW::add_area_to_query(AreaSW *p_area, uint32_t p_area_shape,
                               uint32_t p_self_shape) {
...
void AreaSW::remove_area_from_query(AreaSW *p_area, uint32_t p_area_shape,
                                    uint32_t p_self_shape) {
