...
/// @brief Implementation of the EngineDebugger class for managing profilers, message captures, and script debugging.
///
/// This file contains the core functionality for:
/// - Registering and unregistering profilers with callback functions
/// - Managing message capture handlers
/// - Controlling profiler state and collecting frame data
/// - Polling debugger events and processing breakpoints
/// - Initializing local or remote debugging sessions
/// - Tracking frame timing metrics (frame time, idle time, physics time)
///
/// The EngineDebugger operates as a singleton that coordinates between the engine's
/// core systems and both local and remote debuggers, enabling performance profiling
/// and script-level debugging capabilities.
