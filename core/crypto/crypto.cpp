...
/// \file crypto.cpp
/// \brief Implementation of cryptographic functionality including key management, certificate handling, and resource loading/saving.
///
/// This file provides the core cryptographic operations for the game engine, including:
/// - CryptoKey: RSA key generation, loading, and saving
/// - X509Certificate: X.509 certificate generation, loading, and saving
/// - Crypto: Main cryptographic operations like random byte generation and self-signed certificate creation
/// - ResourceFormatLoaderCrypto: Loads .crt and .key files as engine resources
/// - ResourceFormatSaverCrypto: Saves X509Certificate and CryptoKey resources to disk
///
/// The implementation uses function pointers (_create and _load_default_certificates) to allow
/// platform-specific or module-specific implementations to be plugged in at runtime. When the
/// mbedtls module is disabled, the cryptographic operations return error messages.
///
