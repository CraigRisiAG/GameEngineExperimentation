...
/**
 * @file color.cpp
 * @brief Implementation of Color class methods for color space conversions and
 * operations.
 *
 * This file contains implementations for:
 * - Color format conversions (ARGB32, ABGR32, RGBA32, ARGB64, ABGR64, RGBA64)
 * - HSV color space conversions (get/set hue, saturation, value)
 * - HTML/hex color parsing and generation
 * - Color mathematical operations (addition, subtraction, multiplication,
 * division)
 * - Color utility functions (invert, contrast, equality checks)
 * - Named color lookup from predefined color names
 *
 * The Color class represents colors with floating-point RGBA components
 * (0.0-1.0 range).
 */
#include "color.h"
