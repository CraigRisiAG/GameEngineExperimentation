...
/**
 * @file variant.cpp
 * @brief Implementation of the Variant class for dynamic type handling.
 * 
 * This file contains the implementation of the Variant class, which provides a flexible,
 * type-agnostic container for storing and manipulating values of various types including:
 * - Primitive types: nil, bool, int, float, string
 * - Math types: Vector2/3, Rect2, Transform2D, Plane, AABB, Quaternion, Basis, Transform
 * - Container types: Array, Dictionary
 * - Packed arrays: PackedByteArray, PackedInt32Array, PackedInt64Array, PackedFloat32Array,
 *   PackedFloat64Array, PackedStringArray, PackedVector2Array, PackedVector3Array, PackedColorArray
 * - Object types: Object, RID, Callable, Signal
 * - String types: String, StringName, NodePath
 * - Color type: Color
 * 
 * Key features:
 * - Type conversion and validation with can_convert() and can_convert_strict()
 * - Comparison operators (==, !=, <) with proper type checking
 * - Hash computation for use in dictionaries and sets
 * - String conversion and formatting
 * - Reference counting for objects
 * - Array conversion and manipulation
 * - Call error reporting and diagnostics
 */
#include "variant.h"
