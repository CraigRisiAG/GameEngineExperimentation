...
/// \file input.cpp
/// \brief Implementation of the Input singleton class for handling keyboard, mouse, joystick, and motion input events.
///
/// This file provides the core input system for the game engine, including:
/// - Mouse mode management (visible, hidden, captured, confined)
/// - Input event binding to scripting API via ClassDB
/// - Joystick/gamepad support with vibration and button mapping
/// - Motion sensor input (accelerometer, gyroscope, magnetometer)
/// - Custom cursor management
/// - Action-based input system integration
/// - Editor autocompletion for action names in the tools build
///
/// The Input class operates as a singleton and delegates OS-level mouse operations
/// to the OS class while maintaining its own state for keyboard, joystick, and
