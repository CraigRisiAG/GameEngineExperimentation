...
/**
 * @class OS
 * @brief Abstract base class representing the operating system interface for the game engine.
 * 
 * The OS class provides a platform-independent abstraction layer for operating system functionality,
 * including window management, input handling, file operations, process control, time/date operations,
 * and system resource management.
 * 
 * This is a singleton class that serves as the primary interface between the engine core and
 * platform-specific implementations. Derived classes must implement virtual methods for their
 * respective platforms (e.g., Windows, Linux, macOS, mobile platforms).
 * 
 * Key responsibilities:
 * - Window and video mode management
 * - Input handling (mouse, keyboard, touch, MIDI)
 * - Process and thread management
 * - File system and path operations
 * - Time and date operations
 * - Memory management and diagnostics
 * - Audio and video driver management
 * - Cursor and virtual keyboard management
 * - Environment variables and system information
 * 
 * @note This class uses the singleton pattern and should be accessed via get_singleton().
 * @note Many virtual methods have default implementations that may be overridden by platform-specific subclasses.
 */
#ifndef OS_H
#define OS_H
