...
private:
  ...
  bool _execute(const Array &p_inputs, Object *p_instance,
                Expression::ENode *p_node, Variant &r_ret, String &r_error_str);
...
public:
  ...
  Variant execute(Array p_inputs, Object *p_base = NULL,
