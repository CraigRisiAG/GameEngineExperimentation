...
/// @file joypad_osx.cpp
/// @brief macOS joypad/gamepad input handler using IOHIDManager framework
/// 
/// This module provides joypad input support for macOS through the IOHIDManager API.
/// It detects, configures, and manages connected joypad devices, processing their
/// input events (axes, buttons, hat switches) and force feedback effects.
/// 
/// Key Features:
/// - Automatic joypad device detection and enumeration
/// - Support for joysticks, gamepads, and multi-axis controllers
/// - Axis, button, and hat switch input processing
/// - Force feedback (constant force effects) support
/// - Automatic calibration of axis min/max values
/// - Integration with Godot's InputDefault system
/// 
/// @class joypad
/// @brief Represents a single connected joypad device
/// 
/// Stores device reference, HID elements (axes, buttons, hats), and force feedback data
/// for an individual joypad.
/// 
/// @class JoypadOSX
/// @brief Manager class for all connected joypad devices
/// 
/// Handles device enumeration, configuration, polling, and event processing.
/// Maintains a list of active joypad devices and their states.
