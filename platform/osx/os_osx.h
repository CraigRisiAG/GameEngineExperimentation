...
/**
 * @class OS_OSX
 * @brief macOS-specific operating system implementation extending Unix base class.
 * 
 * Provides platform-specific functionality for macOS including window management,
 * input handling, rendering context management, and system integration.
 * 
 * @details
 * - Supports OpenGL and Vulkan rendering backends
 * - Handles keyboard and mouse input with macOS-specific event processing
 * - Manages audio via CoreAudio and MIDI via CoreMIDI drivers
 * - Provides window management, fullscreen, and display utilities
 * - Supports input method (IME) for text editing
 * - Implements global menu functionality
 * - Manages cursor shapes and custom cursors
 * 
 * @note Uses Objective-C interop through id pointers for AppKit objects.
 * @note Requires macOS 10.9+ for AppKit and CoreAudio frameworks.
 */
#ifndef OS_OSX_H
#define OS_OSX_H
