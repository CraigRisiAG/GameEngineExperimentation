...
/**
 * @class OSIPhone
 * @brief iOS platform abstraction layer for game engine
 * 
 * OSIPhone extends OS_Unix to provide iOS-specific functionality including:
 * - Video rendering (Vulkan support)
 * - Audio playback via CoreAudio
 * - Touch input and gesture handling
 * - Device sensors (accelerometer, gyroscope, magnetometer)
 * - Game Center and In-App Store integration
 * - iCloud support
 * - Virtual keyboard management
 * - Joystick/controller input
 * 
 * @note This class is only compiled when IPHONE_ENABLED is defined
 * @note Vulkan rendering requires VULKAN_ENABLED flag
 * @note Optional features: GAME_CENTER_ENABLED, STOREKIT_ENABLED, ICLOUD_ENABLED
 * 
 * @see OS_Unix
 * @see VideoServer
 * @see AudioDriverCoreAudio
 * @see InputDefault
 */
