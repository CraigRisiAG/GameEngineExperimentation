...
public:
  ...
  static void _bind_methods() {
    ...
    ClassDB::bind_method("_key_ofs_changed",
                         &AnimationTrackKeyEdit::_key_ofs_changed);
    ClassDB::bind_method("_hide_script_from_inspector",
                         &AnimationTrackKeyEdit::_hide_script_from_inspector);
    ClassDB::bind_method("get_root_path",
                         &AnimationTrackKeyEdit::get_root_path);
    ClassDB::bind_method("_dont_undo_redo",
  ...
  bool _set(const StringName &p_name, const Variant &p_value) {
    ...
    if (name == "time" || name == "frame") {
      ...
      undo_redo->add_do_method(animation.ptr(), "track_insert_key", track,
                               new_time, val, trans);
      undo_redo->add_do_method(this, "_key_ofs_changed", animation, key_ofs,
                               new_time);
      undo_redo->add_undo_method(
          animation.ptr(), "track_remove_key_at_position", track, new_time);
      undo_redo->add_undo_method(animation.ptr(), "track_insert_key", track,
                                 key_ofs, val, trans);
      undo_redo->add_undo_method(this, "_key_ofs_changed", animation, new_time,
                                 key_ofs);
    ...
    if (name == "easing") {
      ...
      setting = true;
      undo_redo->create_action(TTR("Anim Change Transition"),
                               UndoRedo::MERGE_ENDS);
      undo_redo->add_do_method(animation.ptr(), "track_set_key_transition",
                               track, key, val);
      undo_redo->add_undo_method(animation.ptr(), "track_set_key_transition",
                                 track, key, prev_val);
    ...
    case Animation::TYPE_TRANSFORM: {
      ...
      undo_redo->add_do_method(animation.ptr(), "track_set_key_value", track,
                               key, d_new);
      undo_redo->add_undo_method(animation.ptr(), "track_set_key_value", track,
                                 key, d_old);
      undo_redo->add_do_method(this, "_update_obj", animation);
      undo_redo->add_undo_method(this, "_update_obj", animation);
      undo_redo->commit_action();
    ...
    case Animation::TYPE_VALUE: {
      ...
      if (name == "value") {
        ...
        setting = true;
        undo_redo->create_action(TTR("Anim Change Keyframe Value"),
                                 UndoRedo::MERGE_ENDS);
        Variant prev = animation->track_get_key_value(track, key);
        undo_redo->add_do_method(animation.ptr(), "track_set_key_value", track,
                                 key, value);
        undo_redo->add_undo_method(animation.ptr(), "track_set_key_value",
                                   track, key, prev);
        undo_redo->add_do_method(this, "_update_obj", animation);
        undo_redo->add_undo_method(this, "_update_obj", animation);
        undo_redo->commit_action();
        ...
        if (what == "type") {
          ...
          if (t != args[idx].get_type()) {
            ...
            if (Variant::can_convert(args[idx].get_type(), t)) {
              ...
              Variant *ptrs[1] = {&old};
              args.write[idx] =
                  Variant::construct(t, (const Variant **)ptrs, 1, err);
            } else {
    ...
    case Animation::TYPE_BEZIER: {
      ...
      if (name == "value") {
        ...
        undo_redo->add_do_method(animation.ptr(), "bezier_track_set_key_value",
                                 track, key, value);
        undo_redo->add_undo_method(
            animation.ptr(), "bezier_track_set_key_value", track, key, prev);
        undo_redo->add_do_method(this, "_update_obj", animation);
        undo_redo->add_undo_method(this, "_update_obj", animation);
        undo_redo->commit_action();
      ...
      if (name == "in_handle") {
        ...
        undo_redo->add_do_method(animation.ptr(),
                                 "bezier_track_set_key_in_handle", track, key,
                                 value);
        undo_redo->add_undo_method(animation.ptr(),
                                   "bezier_track_set_key_in_handle", track, key,
                                   prev);
        undo_redo->add_do_method(this, "_update_obj", animation);
        undo_redo->add_undo_method(this, "_update_obj", animation);
      ...
      if (name == "out_handle") {
        ...
        undo_redo->add_do_method(animation.ptr(),
                                 "bezier_track_set_key_out_handle", track, key,
                                 value);
        undo_redo->add_undo_method(animation.ptr(),
                                   "bezier_track_set_key_out_handle", track,
                                   key, prev);
        undo_redo->add_do_method(this, "_update_obj", animation);
        undo_redo->add_undo_method(this, "_update_obj", animation);
        undo_redo->commit_action();
    ...
    case Animation::TYPE_AUDIO: {
      ...
      if (name == "stream") {
        ...
        undo_redo->add_do_method(animation.ptr(), "audio_track_set_key_stream",
                                 track, key, stream);
        undo_redo->add_undo_method(
            animation.ptr(), "audio_track_set_key_stream", track, key, prev);
        undo_redo->add_do_method(this, "_update_obj", animation);
        undo_redo->add_undo_method(this, "_update_obj", animation);
        undo_redo->commit_action();
      ...
      if (name == "start_offset") {
        ...
        undo_redo->add_do_method(animation.ptr(),
                                 "audio_track_set_key_start_offset", track, key,
                                 value);
        undo_redo->add_undo_method(animation.ptr(),
                                   "audio_track_set_key_start_offset", track,
                                   key, prev);
        undo_redo->add_do_method(this, "_update_obj", animation);
        undo_redo->add_undo_method(this, "_update_obj", animation);
        undo_redo->commit_action();
      ...
      if (name == "end_offset") {
        ...
        undo_redo->add_do_method(animation.ptr(),
                                 "audio_track_set_key_end_offset", track, key,
                                 value);
        undo_redo->add_undo_method(animation.ptr(),
                                   "audio_track_set_key_end_offset", track, key,
                                   prev);
    ...
    case Animation::TYPE_ANIMATION: {
      ...
      if (name == "animation") {
        ...
        undo_redo->create_action(TTR("Anim Change Keyframe Value"),
                                 UndoRedo::MERGE_ENDS);
        StringName prev =
            animation->animation_track_get_key_animation(track, key);
        undo_redo->add_do_method(animation.ptr(),
                                 "animation_track_set_key_animation", track,
                                 key, anim_name);
        undo_redo->add_undo_method(animation.ptr(),
                                   "animation_track_set_key_animation", track,
                                   key, prev);
  ...
  void _get_property_list(List<PropertyInfo> *p_list) const {
    ...
    if (use_fps && animation->get_step() > 0) {
      ...
      p_list->push_back(PropertyInfo(Variant::FLOAT, "frame",
                                     PROPERTY_HINT_RANGE,
                                     "0," + rtos(max_frame) + ",1"));
    } else {
      p_list->push_back(
          PropertyInfo(Variant::FLOAT, "time", PROPERTY_HINT_RANGE,
    ...
    case Animation::TYPE_VALUE: {
      ...
      if (hint.type != Variant::NIL) {
        ...
        if (v.get_type() != Variant::NIL)
          p_list->push_back(
              PropertyInfo(v.get_type(), "value", hint, hint_string));
      }
    ...
    case Animation::TYPE_METHOD: {
      ...
      p_list->push_back(PropertyInfo(Variant::INT, "arg_count",
                                     PROPERTY_HINT_RANGE, "0,5,1"));
      ...
      for (int i = 0; i < args.size(); i++) {
        ...
        p_list->push_back(PropertyInfo(Variant::INT,
                                       "args/" + itos(i) + "/type",
                                       PROPERTY_HINT_ENUM, vtypes));
        if (args[i].get_type() != Variant::NIL)
          p_list->push_back(
              PropertyInfo(args[i].get_type(), "args/" + itos(i) + "/value"));
      }
    ...
    case Animation::TYPE_AUDIO: {
      ...
      p_list->push_back(PropertyInfo(Variant::OBJECT, "stream",
                                     PROPERTY_HINT_RESOURCE_TYPE,
                                     "AudioStream"));
      p_list->push_back(PropertyInfo(Variant::FLOAT, "start_offset",
                                     PROPERTY_HINT_RANGE,
                                     "0,3600,0.01,or_greater"));
      p_list->push_back(PropertyInfo(Variant::FLOAT, "end_offset",
                                     PROPERTY_HINT_RANGE,
                                     "0,3600,0.01,or_greater"));
    ...
    case Animation::TYPE_ANIMATION: {
      ...
      p_list->push_back(PropertyInfo(Variant::STRING_NAME, "animation",
                                     PROPERTY_HINT_ENUM, animations));
    ...
    if (animation->track_get_type(track) == Animation::TYPE_VALUE) {
      p_list->push_back(
          PropertyInfo(Variant::FLOAT, "easing", PROPERTY_HINT_EXP_EASING));
    }
  }
  ...
  void notify_change() { _change_notify(); }

  Node *get_root_path() { return root_path; }
...
public:
  ...
  static void _bind_methods() {
    ...
    ClassDB::bind_method("_update_obj",
    ...
    for (Map<int, List<float>>::Element *E = key_ofs_map.front(); E;
      ...
      for (List<float>::Element *F = E->value().front(); F; F = F->next()) {
        ...
        if (name == "time" || name == "frame") {
          ...
          if (!setting) {
            setting = true;
            undo_redo->create_action(TTR("Anim Multi Change Keyframe Time"),
                                     UndoRedo::MERGE_ENDS);
          }
          ...
          undo_redo->add_do_method(animation.ptr(), "track_remove_key", track,
                                   key);
          undo_redo->add_do_method(animation.ptr(), "track_insert_key", track,
                                   new_time, val, trans);
          undo_redo->add_do_method(this, "_key_ofs_changed", animation, key_ofs,
          ...
          undo_redo->add_undo_method(animation.ptr(), "track_insert_key", track,
                                     key_ofs, val, trans);
          undo_redo->add_undo_method(this, "_key_ofs_changed", animation,
                                     new_time, key_ofs);

          if (existing != -1) {
            Variant v = animation->track_get_key_value(track, existing);
            trans = animation->track_get_key_transition(track, existing);
            undo_redo->add_undo_method(animation.ptr(), "track_insert_key",
                                       track, new_time, v, trans);
          }
        } else if (name == "easing") {
          ...
          if (!setting) {
            setting = true;
            undo_redo->create_action(TTR("Anim Multi Change Transition"),
                                     UndoRedo::MERGE_ENDS);
          }
          undo_redo->add_do_method(animation.ptr(), "track_set_key_transition",
                                   track, key, val);
          undo_redo->add_undo_method(animation.ptr(),
                                     "track_set_key_transition", track, key,
                                     prev_val);
          update_obj = true;
        }
        ...
        case Animation::TYPE_TRANSFORM: {
          ...
          undo_redo->add_do_method(animation.ptr(), "track_set_key_value",
                                   track, key, d_new);
          undo_redo->add_undo_method(animation.ptr(), "track_set_key_value",
                                     track, key, d_old);
          update_obj = true;
        ...
        case Animation::TYPE_VALUE: {
          ...
          if (name == "value") {
            ...
            if (!setting) {
              setting = true;
              undo_redo->create_action(TTR("Anim Multi Change Keyframe Value"),
                                       UndoRedo::MERGE_ENDS);
            }
            Variant prev = animation->track_get_key_value(track, key);
            undo_redo->add_do_method(animation.ptr(), "track_set_key_value",
        ...
        case Animation::TYPE_BEZIER: {
          ...
          if (name == "value") {
            ...
            float prev = animation->bezier_track_get_key_value(track, key);
            undo_redo->add_do_method(animation.ptr(),
                                     "bezier_track_set_key_value", track, key,
                                     value);
            undo_redo->add_undo_method(animation.ptr(),
                                       "bezier_track_set_key_value", track, key,
                                       prev);
            ...
            undo_redo->add_do_method(animation.ptr(),
                                     "bezier_track_set_key_in_handle", track,
                                     key, value);
            undo_redo->add_undo_method(animation.ptr(),
                                       "bezier_track_set_key_in_handle", track,
                                       key, prev);
        ...
        case Animation::TYPE_AUDIO: {
          ...
          if (name == "stream") {
            ...
            RES prev = animation->audio_track_get_key_stream(track, key);
            undo_redo->add_do_method(animation.ptr(),
                                     "audio_track_set_key_stream", track, key,
                                     stream);
            undo_redo->add_undo_method(animation.ptr(),
                                       "audio_track_set_key_stream", track, key,
                                       prev);
            ...
            float prev = animation->audio_track_get_key_end_offset(track, key);
            undo_redo->add_do_method(animation.ptr(),
                                     "audio_track_set_key_end_offset", track,
                                     key, value);
            undo_redo->add_undo_method(animation.ptr(),
                                       "audio_track_set_key_end_offset", track,
                                       key, prev);
  ...
  void _get_property_list(List<PropertyInfo> *p_list) const {
      ...
      if (same_track_type) {
        ...
        for (List<float>::Element *F = E->value().front(); F; F = F->next()) {
          ...
          if (animation->track_get_key_value(first_track, first_key)
                  .get_type() !=
              animation->track_get_key_value(track, key).get_type())
            same_key_type = false;
        }
      }
    }
    ...
    if (same_track_type) {
      ...
      case Animation::TYPE_ANIMATION: {
        ...
        if (root_path &&
            root_path->has_node(animation->track_get_path(first_track))) {

          AnimationPlayer *ap = Object::cast_to<AnimationPlayer>(
              root_path->get_node(animation->track_get_path(first_track)));
          if (ap) {
            List<StringName> anims;
            ap->get_animation_list(&anims);
            for (List<StringName>::Element *G = anims.front(); G;
                 G = G->next()) {
              if (animations != String()) {
                animations += ",";
              }
...
void AnimationTimelineEdit::_anim_length_changed(double p_new_len) {
  ...
  undo_redo->add_undo_method(animation.ptr(), "set_length",
...
void AnimationTimelineEdit::_anim_loop_pressed() {
  ...
  undo_redo->add_undo_method(animation.ptr(), "set_loop",
                             animation->has_loop());
  undo_redo->commit_action();
}
...
int AnimationTimelineEdit::get_name_limit() const {
  ...
  int limit = MAX(name_limit, add_track->get_minimum_size().width +
...
void AnimationTimelineEdit::_notification(int p_what) {
  ...
  if (p_what == NOTIFICATION_ENTER_TREE) {
    ...
    add_track->get_popup()->add_icon_item(get_icon("KeyValue", "EditorIcons"),
                                          TTR("Property Track"));
    add_track->get_popup()->add_icon_item(get_icon("KeyXform", "EditorIcons"),
                                          TTR("3D Transform Track"));
    add_track->get_popup()->add_icon_item(get_icon("KeyCall", "EditorIcons"),
                                          TTR("Call Method Track"));
    add_track->get_popup()->add_icon_item(get_icon("KeyBezier", "EditorIcons"),
                                          TTR("Bezier Curve Track"));
    add_track->get_popup()->add_icon_item(get_icon("KeyAudio", "EditorIcons"),
  ...
  if (p_what == NOTIFICATION_DRAW) {
    ...
    Ref<Texture2D> hsize_icon = get_icon("Hsize", "EditorIcons");
    hsize_rect = Rect2(get_name_limit() - hsize_icon->get_width() - 2 * EDSCALE,
                       (get_size().height - hsize_icon->get_height()) / 2,
                       hsize_icon->get_width(), hsize_icon->get_height());
      ...
      for (int i = 0; i < animation->get_track_count(); i++) {
        ...
        if (animation->track_get_key_count(i) > 0) {
          ...
          float end = animation->track_get_key_time(
              i, animation->track_get_key_count(i) - 1);
          /*if (animation->track_get_type(i) == Animation::TYPE_BEZIER) {
                  end += animation->bezier_track_get_key_out_handle(i,
          animation->track_get_key_count(i) - 1).x; } not worth it since they
          have no use */
...

    {
      ...
      draw_rect(Rect2(Point2(get_name_limit(), 0), Point2(zoomw - 1, h)),
                notimecol);
      ...
      if (begin_px < zoomw && end_px > 0) {
        ...
        draw_rect(Rect2(Point2(get_name_limit() + begin_px, 0),
    ...
    if (use_fps) {
      ...
      if (step_size > 0) {
        ...
        for (int i = 0; i < zoomw; i++) {
          ...
          if (frame != prev_frame && i >= prev_frame_ofs) {
            ...
            draw_line(Point2(get_name_limit() + i, 0),
                      Point2(get_name_limit() + i, h), linecolor,
                      Math::round(EDSCALE));

            draw_string(
                font,
                Point2(get_name_limit() + i + 3 * EDSCALE,
                       (h - font->get_height()) / 2 + font->get_ascent())
                    .floor(),
                itos(frame), sub ? color_time_dec : color_time_sec, zoomw - i);
            prev_frame_ofs =
                i + font->get_string_size(itos(frame)).x + 5 * EDSCALE;
          }
        }
      }
      ...
      for (int i = 0; i < zoomw; i++) {
        ...
        if ((sc / step) != (prev_sc / step) || (prev_sc < 0 && sc >= 0)) {
          ...
          draw_string(
              font,
              Point2(get_name_limit() + i + 3,
                     (h - font->get_height()) / 2 + font->get_ascent())
                  .floor(),
              String::num((scd - (scd % step)) / double(SC_ADJ), decimals),
...
void AnimationTimelineEdit::set_zoom(Range *p_zoom) {
  zoom = p_zoom;
  zoom->connect("value_changed",
                callable_mp(this, &AnimationTimelineEdit::_zoom_changed));
}
...
void AnimationTimelineEdit::update_play_position() { play_position->update(); }
...
void AnimationTimelineEdit::_play_position_draw() {
  ...
  if (px >= get_name_limit() &&
    ...
    play_position->draw_texture(
        ...
        Point2(px - get_icon("TimelineIndicator", "EditorIcons")->get_width() *
                        0.5,
               0),
        color);
  }
...
void AnimationTimelineEdit::_gui_input(const Ref<InputEvent> &p_event) {
  ...
  if (mm.is_valid()) {
    ...
    if (hsize_rect.has_point(mm->get_position())) {
      // Change the cursor to indicate that the track name column's width can be
      // adjusted
...
void AnimationTimelineEdit::_bind_methods() {
  ...
  ADD_SIGNAL(MethodInfo("timeline_changed",
                        PropertyInfo(Variant::FLOAT, "position"),
                        PropertyInfo(Variant::BOOL, "drag")));
  ADD_SIGNAL(MethodInfo("track_added", PropertyInfo(Variant::INT, "track")));
  ADD_SIGNAL(
      MethodInfo("length_changed", PropertyInfo(Variant::FLOAT, "size")));
}
...
AnimationTimelineEdit::AnimationTimelineEdit() {
  ...
  play_position->connect(
      "draw", callable_mp(this, &AnimationTimelineEdit::_play_position_draw));
  ...
  length->connect(
      "value_changed",
      callable_mp(this, &AnimationTimelineEdit::_anim_length_changed));
  len_hb->add_child(length);
  loop = memnew(ToolButton);
  loop->set_tooltip(TTR("Animation Looping"));
  loop->connect("pressed",
                callable_mp(this, &AnimationTimelineEdit::_anim_loop_pressed));
  loop->set_toggle_mode(true);
  len_hb->add_child(loop);
  add_child(len_hb);

  add_track->hide();
  add_track->get_popup()->connect(
      "index_pressed", callable_mp(this, &AnimationTimelineEdit::_track_added));
  len_hb->hide();
...
void AnimationTrackEdit::_notification(int p_what) {
  ...
  if (p_what == NOTIFICATION_DRAW) {
    ...
    if (has_focus()) {
      ...
      draw_rect(
          Rect2(Point2(1 * EDSCALE, 0), get_size() - Size2(1 * EDSCALE, 0)),
          accent, false);
    }

    Ref<Font> font = get_font("font", "Label");
    Color color = get_color("font_color", "Label");
    Ref<Texture2D> type_icons[6] = {get_icon("KeyValue", "EditorIcons"),
...

    {
      ...
      Ref<Texture2D> check = animation->track_is_enabled(track)
      ...
      check_rect =
          Rect2(Point2(ofs, int(get_size().height - check->get_height()) / 2),
                check->get_size());
      ...
      draw_texture(
          type_icon,
          Point2(ofs, int(get_size().height - type_icon->get_height()) / 2));
      ...
      if (in_group) {
        ...
        draw_texture(
            icon, Point2(ofs, int(get_size().height - icon->get_height()) / 2));
        icon_cache = icon;
      ...
      Vector2 string_pos =
          Point2(ofs, (get_size().height - font->get_height()) / 2 +
                          font->get_ascent());
      ...
      for (int i = 0; i < animation->track_get_key_count(track); i++) {
        ...
        if (editor->is_key_selected(track, i) &&
          ...
          offset = editor->snap_time(
              offset + editor->get_moving_selection_offset(), true);
        }
        ...
        if (i < animation->track_get_key_count(track) - 1) {
          ...
          if (editor->is_key_selected(track, i + 1) &&
              editor->is_moving_selection()) {
            offset_n = editor->snap_time(offset_n +
                                         editor->get_moving_selection_offset());
          }
        ...
        draw_key(i, scale, int(offset), editor->is_key_selected(track, i),
                 limit, limit_end);
      }
    }
...

    {
      ...
      Ref<Texture2D> interp_icon[3] = {get_icon("InterpRaw", "EditorIcons"),
                                       get_icon("InterpLinear", "EditorIcons"),
                                       get_icon("InterpCubic", "EditorIcons")};
      Ref<Texture2D> cont_icon[4] = {get_icon("TrackContinuous", "EditorIcons"),
      ...
      ofs += hsep;
      {
        ...
        if (animation->track_get_type(track) == Animation::TYPE_VALUE) {
          draw_texture(down_icon, Vector2(ofs, int(get_size().height -
                                                   down_icon->get_height()) /
                                                   2));
        ...
        draw_line(Point2(ofs + hsep * 0.5, 0),
                  Point2(ofs + hsep * 0.5, get_size().height), linecolor,
                  Math::round(EDSCALE));
        ofs += hsep;
      }

      {
        ...
        if (animation->track_get_type(track) == Animation::TYPE_VALUE ||
            animation->track_get_type(track) == Animation::TYPE_TRANSFORM) {
    ...
    if (in_group) {
      draw_line(Vector2(timeline->get_name_limit(), get_size().height),
                get_size(), linecolor, Math::round(EDSCALE));
    } else {
      draw_line(Vector2(0, get_size().height), get_size(), linecolor,
                Math::round(EDSCALE));
    }
...
Rect2 AnimationTrackEdit::get_key_rect(int p_index, float p_pixels_sec) {
  ...
  if (!animation.is_valid())
    return Rect2();
  Rect2 rect = Rect2(-type_icon->get_width() / 2, 0, type_icon->get_width(),
                     get_size().height);
...
void AnimationTrackEdit::draw_key_link(int p_index, float p_pixels_sec, int p_x,
                                       int p_next_x, int p_clip_left,
                                       int p_clip_right) {
  ...
  draw_line(Point2(from_x + 1, get_size().height / 2),
            Point2(to_x, get_size().height / 2), color,
            Math::round(2 * EDSCALE));
}

void AnimationTrackEdit::draw_key(int p_index, float p_pixels_sec, int p_x,
                                  bool p_selected, int p_clip_left,
                                  int p_clip_right) {
  ...
  Vector2 ofs(p_x - icon_to_draw->get_width() / 2,
  ...
  if (animation->track_get_type(track) == Animation::TYPE_METHOD) {
    ...
    if (limit > 0) {
      draw_string(font,
                  Vector2(p_x + icon_to_draw->get_width(),
...
// helper
void AnimationTrackEdit::draw_rect_clipped(const Rect2 &p_rect,
                                           const Color &p_color,
                                           bool p_filled) {
...
void AnimationTrackEdit::draw_texture_clipped(const Ref<Texture2D> &p_texture,
                                              const Vector2 &p_pos) {

  draw_texture_region_clipped(p_texture, Rect2(p_pos, p_texture->get_size()),
                              Rect2(Point2(), p_texture->get_size()));
}

void AnimationTrackEdit::draw_texture_region_clipped(
    const Ref<Texture2D> &p_texture, const Rect2 &p_rect,
...
void AnimationTrackEdit::set_animation_and_track(
    const Ref<Animation> &p_animation, int p_track) {
...
void AnimationTrackEdit::set_timeline(AnimationTimelineEdit *p_timeline) {
  timeline = p_timeline;
  timeline->connect("zoom_changed",
                    callable_mp(this, &AnimationTrackEdit::_zoom_changed));
  timeline->connect("name_limit_changed",
                    callable_mp(this, &AnimationTrackEdit::_zoom_changed));
}
...
void AnimationTrackEdit::update_play_position() { play_position->update(); }
...
void AnimationTrackEdit::_path_entered(const String &p_text) {
  ...
  undo_redo->add_undo_method(animation.ptr(), "track_set_path", track,
                             animation->track_get_path(track));
  undo_redo->commit_action();
}

bool AnimationTrackEdit::_is_value_key_valid(
    const Variant &p_key_value, Variant::Type &r_valid_type) const {
  ...
  Node *node = root->get_node_and_resource(animation->track_get_path(track),
                                           res, leftover_path);
  ...
  if (p_pos.x >= limit_start_hitbox && p_pos.x <= limit_end) {
    ...
    if (key_idx != -1) {
      ...
      case Animation::TYPE_VALUE: {
        ...
        Variant::Type valid_type = Variant::NIL;
        if (!_is_value_key_valid(v, valid_type)) {
          text += "Value: " + String(v) + "  (Invalid, expected type: " +
                  Variant::get_type_name(valid_type) + ")\n";
        } else {
          text += "Value: " + String(v) + "\n";
        }
        text += "Easing: " +
                rtos(animation->track_get_key_transition(track, key_idx));
      ...
      case Animation::TYPE_ANIMATION: {
        ...
        String name =
            animation->animation_track_get_key_animation(track, key_idx);
...
void AnimationTrackEdit::_gui_input(const Ref<InputEvent> &p_event) {
  ...
  if (mb.is_valid() && mb->is_pressed() &&
    ...
    if (check_rect.has_point(pos)) {
      ...
      undo_redo->add_do_method(animation.ptr(), "track_set_enabled", track,
                               !animation->track_is_enabled(track));
      undo_redo->add_undo_method(animation.ptr(), "track_set_enabled", track,
                                 animation->track_is_enabled(track));
      undo_redo->commit_action();
      update();
      accept_event();
    ...
    if (update_mode_rect.has_point(pos)) {
      if (!menu) {
        ...
        add_child(menu);
        menu->connect("id_pressed",
                      callable_mp(this, &AnimationTrackEdit::_menu_selected));
      }
      menu->clear();
      menu->add_icon_item(get_icon("TrackContinuous", "EditorIcons"),
                          TTR("Continuous"), MENU_CALL_MODE_CONTINUOUS);
      menu->add_icon_item(get_icon("TrackDiscrete", "EditorIcons"),
                          TTR("Discrete"), MENU_CALL_MODE_DISCRETE);
      menu->add_icon_item(get_icon("TrackTrigger", "EditorIcons"),
                          TTR("Trigger"), MENU_CALL_MODE_TRIGGER);
      menu->add_icon_item(get_icon("TrackCapture", "EditorIcons"),
                          TTR("Capture"), MENU_CALL_MODE_CAPTURE);
      menu->set_as_minsize();

      Vector2 popup_pos = get_global_position() + update_mode_rect.position +
    ...
    if (interp_mode_rect.has_point(pos)) {
      ...
      menu->clear();
      menu->add_icon_item(get_icon("InterpRaw", "EditorIcons"), TTR("Nearest"),
                          MENU_INTERPOLATION_NEAREST);
      menu->add_icon_item(get_icon("InterpLinear", "EditorIcons"),
                          TTR("Linear"), MENU_INTERPOLATION_LINEAR);
      menu->add_icon_item(get_icon("InterpCubic", "EditorIcons"), TTR("Cubic"),
                          MENU_INTERPOLATION_CUBIC);
      menu->set_as_minsize();

      Vector2 popup_pos = get_global_position() + interp_mode_rect.position +
    ...
    if (loop_mode_rect.has_point(pos)) {
      ...
      menu->clear();
      menu->add_icon_item(get_icon("InterpWrapClamp", "EditorIcons"),
                          TTR("Clamp Loop Interp"), MENU_LOOP_CLAMP);
      menu->add_icon_item(get_icon("InterpWrapLoop", "EditorIcons"),
                          TTR("Wrap Loop Interp"), MENU_LOOP_WRAP);
      menu->set_as_minsize();
        ...
        if (mb->get_command() || mb->get_shift()) {
          if (editor->is_key_selected(track, key_idx)) {
            ...
            moving_selection_from_ofs =
                (mb->get_position().x - limit) / timeline->get_zoom_scale();
          }
        } else {
          if (!editor->is_key_selected(track, key_idx)) {
  ...
  if (mb.is_valid() && mb->is_pressed() &&
    ...
    if (pos.x >= timeline->get_name_limit() &&
      ...
      float offset =
          (pos.x - timeline->get_name_limit()) / timeline->get_zoom_scale();
      if (!menu) {
        menu = memnew(PopupMenu);
        add_child(menu);
        menu->connect("id_pressed",
      ...
      menu->clear();
      menu->add_icon_item(get_icon("Key", "EditorIcons"), TTR("Insert Key"),
                          MENU_KEY_INSERT);
      if (editor->is_selection_active()) {
        menu->add_separator();
        menu->add_icon_item(get_icon("Duplicate", "EditorIcons"),
                            TTR("Duplicate Key(s)"), MENU_KEY_DUPLICATE);
        menu->add_separator();
        menu->add_icon_item(get_icon("Remove", "EditorIcons"),
                            TTR("Delete Key(s)"), MENU_KEY_DELETE);
      }
      menu->set_as_minsize();
  ...
  if (mb.is_valid() && !mb->is_pressed() &&
    ...
    if (!path) {
      ...
      path->connect("text_entered",
                    callable_mp(this, &AnimationTrackEdit::_path_entered));
    }
...
bool AnimationTrackEdit::can_drop_data(const Point2 &p_point,
...
void AnimationTrackEdit::drop_data(const Point2 &p_point,
...
void AnimationTrackEdit::_menu_selected(int p_index) {
  ...
  case MENU_CALL_MODE_CAPTURE: {
    ...
    undo_redo->add_do_method(animation.ptr(), "value_track_set_update_mode",
                             track, update_mode);
    undo_redo->add_undo_method(animation.ptr(), "value_track_set_update_mode",
                               track,
  ...
  case MENU_INTERPOLATION_CUBIC: {
    ...
    Animation::InterpolationType interp_mode =
        Animation::InterpolationType(p_index - MENU_INTERPOLATION_NEAREST);
    undo_redo->create_action(TTR("Change Animation Interpolation Mode"));
    undo_redo->add_do_method(animation.ptr(), "track_set_interpolation_type",
                             track, interp_mode);
    undo_redo->add_undo_method(animation.ptr(), "track_set_interpolation_type",
                               track,
                               animation->track_get_interpolation_type(track));
    undo_redo->commit_action();
    update();
  ...
  case MENU_LOOP_CLAMP: {
    ...
    undo_redo->add_do_method(
        animation.ptr(), "track_set_interpolation_loop_wrap", track, loop_wrap);
    undo_redo->add_undo_method(
        animation.ptr(), "track_set_interpolation_loop_wrap", track,
...
void AnimationTrackEdit::append_to_selection(const Rect2 &p_box,
  ...
  Rect2 select_rect(limit_start_hitbox, 0,
...
void AnimationTrackEdit::_bind_methods() {
  ...
  ADD_SIGNAL(MethodInfo("dropped", PropertyInfo(Variant::INT, "from_track"),
                        PropertyInfo(Variant::INT, "to_track")));
  ADD_SIGNAL(MethodInfo("insert_key", PropertyInfo(Variant::FLOAT, "ofs")));
  ADD_SIGNAL(MethodInfo("select_key", PropertyInfo(Variant::INT, "index"),
...
AnimationTrackEdit::AnimationTrackEdit() {
  ...
  play_position->set_anchors_and_margins_preset(PRESET_WIDE);
  play_position->connect(
      "draw", callable_mp(this, &AnimationTrackEdit::_play_position_draw));
...
AnimationTrackEdit *AnimationTrackEditPlugin::create_value_track_edit(
    Object *p_object, Variant::Type p_type, const String &p_property,
    PropertyHint p_hint, const String &p_hint_string, int p_usage) {
  if (get_script_instance()) {
    Variant args[6] = {p_object, p_type,        p_property,
                       p_hint,   p_hint_string, p_usage};

    Variant *argptrs[6] = {&args[0], &args[1], &args[2],
                           &args[3], &args[4], &args[5]};

    Callable::CallError ce;
    return Object::cast_to<AnimationTrackEdit>(
        get_script_instance()
            ->call("create_value_track_edit", (const Variant **)&argptrs, 6, ce)
            .operator Object *());
  }
  return NULL;
}
...
AnimationTrackEdit *
AnimationTrackEditPlugin::create_animation_track_edit(Object *p_object) {
  if (get_script_instance()) {
    return Object::cast_to<AnimationTrackEdit>(
        get_script_instance()
...
void AnimationTrackEditGroup::_notification(int p_what) {
  ...
  if (p_what == NOTIFICATION_DRAW) {
    ...
    if (root && root->has_node(node)) {
      ...
      if (n &&
          EditorNode::get_singleton()->get_editor_selection()->is_selected(n)) {
    ...
    draw_line(Point2(timeline->get_name_limit(), 0),
              Point2(timeline->get_name_limit(), get_size().height), linecolor,
              Math::round(EDSCALE));
    draw_line(Point2(get_size().width - timeline->get_buttons_width(), 0),
              Point2(get_size().width - timeline->get_buttons_width(),
                     get_size().height),
              linecolor, Math::round(EDSCALE));
    ...
    draw_string(font,
                Point2(ofs, int(get_size().height - font->get_height()) / 2 +
                                font->get_ascent()),
                node_name, color, timeline->get_name_limit() - ofs);
...
void AnimationTrackEditGroup::set_type_and_name(const Ref<Texture2D> &p_type,
                                                const String &p_name,
...
void AnimationTrackEditGroup::set_timeline(AnimationTimelineEdit *p_timeline) {
  timeline = p_timeline;
  timeline->connect("zoom_changed",
                    callable_mp(this, &AnimationTrackEditGroup::_zoom_changed));
  timeline->connect("name_limit_changed",
                    callable_mp(this, &AnimationTrackEditGroup::_zoom_changed));
}
...
void AnimationTrackEditGroup::_zoom_changed() { update(); }
...
void AnimationTrackEditor::set_animation(const Ref<Animation> &p_anim) {
  ...
  if (animation.is_valid()) {
    animation->disconnect(
        "changed",
        callable_mp(this, &AnimationTrackEditor::_animation_changed));
    _clear_selection();
  }
  animation = p_anim;
...
void AnimationTrackEditor::_root_removed(Node *p_root) { root = NULL; }

void AnimationTrackEditor::set_root(Node *p_root) {
  if (root) {
    root->disconnect("tree_exiting",
                     callable_mp(this, &AnimationTrackEditor::_root_removed));
  }

  root = p_root;

  if (root) {
    root->connect("tree_exiting",
                  callable_mp(this, &AnimationTrackEditor::_root_removed),
                  make_binds(), CONNECT_ONESHOT);
  }
...
void AnimationTrackEditor::cleanup() { set_animation(Ref<Animation>()); }
...
void AnimationTrackEditor::_track_remove_request(int p_track) {
  ...
  if (idx >= 0 && idx < animation->get_track_count()) {
    ...
    undo_redo->add_undo_method(animation.ptr(), "add_track",
                               animation->track_get_type(idx), idx);
    undo_redo->add_undo_method(animation.ptr(), "track_set_path", idx,
    ...
    for (int i = 0; i < animation->track_get_key_count(idx); i++) {
      ...
      undo_redo->add_undo_method(animation.ptr(), "track_insert_key", idx, time,
                                 v);
      undo_redo->add_undo_method(animation.ptr(), "track_set_key_transition",
                                 idx, i, trans);
    }
    ...
    if (bool(EDITOR_DEF("editors/animation/confirm_insert_track", true))) {
      ...
      if (num_tracks == 1)
        insert_confirm_text->set_text(vformat(
            TTR("Create NEW track for %s and insert key?"), p_id.query));
      else
        insert_confirm_text->set_text(
            vformat(TTR("Create %d NEW tracks and insert keys?"), num_tracks));
...
void AnimationTrackEditor::insert_transform_key(Spatial *p_node,
                                                const String &p_sub,
...
void AnimationTrackEditor::insert_node_value_key(Node *p_node,
...
void AnimationTrackEditor::insert_value_key(const String &p_property,
                                            const Variant &p_value,
                                            bool p_advance) {
...
PropertyInfo
AnimationTrackEditor::_find_hint_for_track(int p_idx, NodePath &r_base_path,
...
static Vector<String> _get_bezier_subindices_for_type(Variant::Type p_type,
                                                      bool *r_valid = NULL) {
...
int AnimationTrackEditor::_confirm_insert(InsertData p_id, int p_last_track,
  ...
  if (p_id.track_idx < 0) {
    ...
    if (p_create_beziers) {
      ...
      if (valid) {
        for (int i = 0; i < subindices.size(); i++) {
          ...
          id.type = Animation::TYPE_BEZIER;
          id.value =
              p_id.value.get(subindices[i].substr(1, subindices[i].length()));
    ...
    if (p_id.type == Animation::TYPE_VALUE ||
...

      {
        ...
        if (h.type == Variant::FLOAT || h.type == Variant::VECTOR2 ||
            ...
            h.type == Variant::TRANSFORM2D || h.type == Variant::TRANSFORM) {
    ...
    undo_redo->add_do_method(animation.ptr(), "track_set_path", p_id.track_idx,
                             p_id.path);
    if (p_id.type == Animation::TYPE_VALUE)
      undo_redo->add_do_method(animation.ptr(), "value_track_set_update_mode",
                               p_id.track_idx, update_mode);
  ...
  undo_redo->add_do_method(animation.ptr(), "track_insert_key", p_id.track_idx,
                           time, value);
  ...
  if (created) {
    ...
    undo_redo->add_undo_method(animation.ptr(), "remove_track",
                               animation->get_track_count());
    p_last_track++;
  } else {

    undo_redo->add_undo_method(animation.ptr(), "track_remove_key_at_position",
                               p_id.track_idx, time);
  ...
  for (int i = 0; i < animation->get_track_count(); i++) {
      ...
      if (root && root->has_node_and_resource(path)) {
        ...
        if (object && !leftover_path.empty()) {
          ...
          for (int j = 0; j < track_edit_plugins.size(); j++) {
            track_edit = track_edit_plugins.write[j]->create_value_track_edit(
                object, pinfo.type, pinfo.name, pinfo.hint, pinfo.hint_string,
                pinfo.usage);
            if (track_edit) {
              break;
            }
    ...
    if (animation->track_get_type(i) == Animation::TYPE_ANIMATION) {
      ...
      if (node && Object::cast_to<AnimationPlayer>(node)) {
        for (int j = 0; j < track_edit_plugins.size(); j++) {
          track_edit =
              track_edit_plugins.write[j]->create_animation_track_edit(node);
          if (track_edit) {
            break;
          }
        }
    ...
    track_edit->connect(
        "timeline_changed",
        callable_mp(this, &AnimationTrackEditor::_timeline_changed));
    track_edit->connect(
        "remove_request",
        callable_mp(this, &AnimationTrackEditor::_track_remove_request),
        varray(), CONNECT_DEFERRED);
    track_edit->connect(
        "dropped", callable_mp(this, &AnimationTrackEditor::_dropped_track),
        varray(), CONNECT_DEFERRED);
    track_edit->connect(
        "insert_key",
        callable_mp(this, &AnimationTrackEditor::_insert_key_from_track),
        varray(i), CONNECT_DEFERRED);
    track_edit->connect("select_key",
                        callable_mp(this, &AnimationTrackEditor::_key_selected),
                        varray(i), CONNECT_DEFERRED);
    track_edit->connect(
        "deselect_key",
        callable_mp(this, &AnimationTrackEditor::_key_deselected), varray(i),
        CONNECT_DEFERRED);
    track_edit->connect("bezier_edit",
                        callable_mp(this, &AnimationTrackEditor::_bezier_edit),
                        varray(i), CONNECT_DEFERRED);
    track_edit->connect(
        "move_selection_begin",
        callable_mp(this, &AnimationTrackEditor::_move_selection_begin));
    track_edit->connect(
        "move_selection",
        callable_mp(this, &AnimationTrackEditor::_move_selection));
    track_edit->connect(
        "move_selection_commit",
        callable_mp(this, &AnimationTrackEditor::_move_selection_commit));
    track_edit->connect(
        "move_selection_cancel",
        callable_mp(this, &AnimationTrackEditor::_move_selection_cancel));

    track_edit->connect(
        "duplicate_request",
        callable_mp(this, &AnimationTrackEditor::_edit_menu_pressed),
        varray(EDIT_DUPLICATE_SELECTION), CONNECT_DEFERRED);
    track_edit->connect(
        "duplicate_transpose_request",
        callable_mp(this, &AnimationTrackEditor::_edit_menu_pressed),
        varray(EDIT_DUPLICATE_TRANSPOSED), CONNECT_DEFERRED);
    track_edit->connect(
        "delete_request",
        callable_mp(this, &AnimationTrackEditor::_edit_menu_pressed),
        varray(EDIT_DELETE_SELECTION), CONNECT_DEFERRED);
  }
}
...
void AnimationTrackEditor::_notification(int p_what) {
  ...
  if (p_what == NOTIFICATION_READY) {
    EditorNode::get_singleton()->get_editor_selection()->connect(
        "selection_changed",
        callable_mp(this, &AnimationTrackEditor::_selection_changed));
  }
...
void AnimationTrackEditor::_update_step(double p_new_step) {
  ...
  undo_redo->add_undo_method(animation.ptr(), "set_step",
                             animation->get_step());
  step->set_block_signals(true);
  undo_redo->commit_action();
  step->set_block_signals(false);
...
void AnimationTrackEditor::_dropped_track(int p_from_track, int p_to_track) {
  ...
  undo_redo->add_do_method(animation.ptr(), "track_move_to", p_from_track,
                           p_to_track);
  ...
  undo_redo->add_undo_method(animation.ptr(), "track_move_to", to_track_real,
                             p_to_track > p_from_track ? p_from_track
                                                       : p_from_track + 1);
...
void AnimationTrackEditor::_new_track_node_selected(NodePath p_path) {
  ...
  case Animation::TYPE_METHOD: {
    ...
    undo_redo->add_do_method(animation.ptr(), "track_set_path",
                             animation->get_track_count(), path_to);
    undo_redo->add_undo_method(animation.ptr(), "remove_track",
                               animation->get_track_count());
    undo_redo->commit_action();
  ...
  case Animation::TYPE_ANIMATION: {
    ...
    if (!node->is_class("AnimationPlayer")) {
      EditorNode::get_singleton()->show_warning(
          TTR("Animation tracks can only point to AnimationPlayer nodes."));
      return;
    }

    if (node == AnimationPlayerEditor::singleton->get_player()) {
      EditorNode::get_singleton()->show_warning(
          TTR("An animation player can't animate itself, only other players."));
      return;
    }
...
void AnimationTrackEditor::_new_track_property_selected(String p_name) {
  ...
  if (adding_track_type == Animation::TYPE_VALUE) {
    ...
    undo_redo->add_do_method(animation.ptr(), "add_track", adding_track_type);
    undo_redo->add_do_method(animation.ptr(), "track_set_path",
                             animation->get_track_count(), full_path);
    undo_redo->add_do_method(animation.ptr(), "value_track_set_update_mode",
                             animation->get_track_count(), update_mode);
    undo_redo->add_undo_method(animation.ptr(), "remove_track",
                               animation->get_track_count());
    undo_redo->commit_action();
  } else {
    ...
    for (int i = 0; i < subindices.size(); i++) {
      undo_redo->add_do_method(animation.ptr(), "add_track", adding_track_type);
      undo_redo->add_do_method(animation.ptr(), "track_set_path",
                               base_track + i, full_path + subindices[i]);
...
void AnimationTrackEditor::_insert_key_from_track(float p_ofs, int p_track) {
  ...
  while (animation->track_find_key(p_track, p_ofs, true) !=
         -1) { // make sure insertion point is valid
    p_ofs += 0.001;
  }
  ...
  case Animation::TYPE_TRANSFORM: {
    ...
    undo_redo->add_do_method(animation.ptr(), "transform_track_insert_key",
                             p_track, p_ofs, loc, rot, scale);
    undo_redo->add_undo_method(animation.ptr(), "track_remove_key_at_position",
                               p_track, p_ofs);
    undo_redo->commit_action();
  ...
  case Animation::TYPE_VALUE: {
    ...
    undo_redo->add_do_method(animation.ptr(), "track_insert_key", p_track,
                             p_ofs, value);
    ...
    if (E->get().name == p_method) {
      ...
      for (int i = 0; i < E->get().arguments.size(); i++) {
        ...
        if (i >= first_defarg) {
          ...
          Callable::CallError ce;
          Variant arg =
              Variant::construct(E->get().arguments[i].type, NULL, 0, ce);
          params.push_back(arg);
        }
      }
      d["args"] = params;
      ...
      undo_redo->add_do_method(animation.ptr(), "track_insert_key",
                               insert_key_from_track_call_track,
                               insert_key_from_track_call_ofs, d);
      undo_redo->add_undo_method(
          animation.ptr(), "track_remove_key_at_position",
          insert_key_from_track_call_track, insert_key_from_track_call_ofs);
      undo_redo->commit_action();
...
void AnimationTrackEditor::_key_selected(int p_key, bool p_single,
                                         int p_track) {
...
void AnimationTrackEditor::_update_key_edit() {
  ...
  if (selection.size() == 1) {
    ...
    float ofs = animation->track_get_key_time(key_edit->track,
...
void AnimationTrackEditor::_select_at_anim(const Ref<Animation> &p_anim,
                                           int p_track, float p_pos) {
...
void AnimationTrackEditor::_move_selection_commit() {
  ...
  for (Map<SelectedKey, KeyInfo>::Element *E = selection.back(); E;
    ...
    undo_redo->add_do_method(animation.ptr(), "track_remove_key",
                             E->key().track, E->key().key);
  }
  ...
  for (Map<SelectedKey, KeyInfo>::Element *E = selection.back(); E;
    ...
    undo_redo->add_do_method(animation.ptr(), "track_remove_key_at_position",
                             E->key().track, newtime);
  ...
  for (Map<SelectedKey, KeyInfo>::Element *E = selection.back(); E;
    ...
    undo_redo->add_do_method(
        animation.ptr(), "track_insert_key", E->key().track, newpos,
  ...
  for (Map<SelectedKey, KeyInfo>::Element *E = selection.back(); E;
    ...
    undo_redo->add_undo_method(
        animation.ptr(), "track_insert_key", E->key().track, E->get().pos,
        animation->track_get_key_value(E->key().track, E->key().key),
        animation->track_get_key_transition(E->key().track, E->key().key));
  }
  ...
  for (List<_AnimMoveRestore>::Element *E = to_restore.front(); E;
    ...
    undo_redo->add_undo_method(animation.ptr(), "track_insert_key", amr.track,
                               amr.time, amr.key, amr.transition);
  }
  ...
  for (Map<SelectedKey, KeyInfo>::Element *E = selection.back(); E;
    ...
    undo_redo->add_do_method(this, "_select_at_anim", animation, E->key().track,
                             newpos);
    undo_redo->add_undo_method(this, "_select_at_anim", animation,
                               E->key().track, oldpos);
  }
...
void AnimationTrackEditor::_scroll_input(const Ref<InputEvent> &p_event) {
    ...
    if (mb->is_pressed()) {
      ...
      if (box_selection->is_visible_in_tree()) {
        ...
        if (_get_track_selected() == -1 &&
            track_edits.size() > 0) { // minimal hack to make shortcuts work
  ...
  if (mm.is_valid() && mm->get_button_mask() & BUTTON_MASK_MIDDLE) {
    ...
    timeline->set_value(timeline->get_value() -
...
void AnimationTrackEditor::_anim_duplicate_keys(bool transpose) {
  ...
  if (selection.size() && animation.is_valid() &&
      (!transpose || (_get_track_selected() >= 0 &&
    ...
    for (Map<SelectedKey, KeyInfo>::Element *E = selection.back(); E;
      ...
      undo_redo->add_do_method(
          animation.ptr(), "track_insert_key", dst_track, dst_time,
          animation->track_get_key_value(E->key().track, E->key().key),
          animation->track_get_key_transition(E->key().track, E->key().key));
      undo_redo->add_undo_method(
          animation.ptr(), "track_remove_key_at_position", dst_track, dst_time);
    ...
    for (List<Pair<int, float>>::Element *E = new_selection_values.front(); E;
         E = E->next()) {
...
void AnimationTrackEditor::_edit_menu_pressed(int p_option) {
  ...
  case EDIT_COPY_TRACKS: {
    ...
    for (int i = 0; i < animation->get_track_count(); i++) {
      ...
      if (node) {
        ...
        path = NodePath(node->get_path().get_names(), path.get_subnames(),
                        true); // store full path instead for copying
      } else {
        text = path;
        int sep = text.find(":");
        if (sep != -1) {
  ...
  case EDIT_PASTE_TRACKS: {
    ...
    for (int i = 0; i < track_clipboard.size(); i++) {
      undo_redo->add_do_method(animation.ptr(), "add_track",
      ...
      if (root) {
        ...
        if (exists) {
          path = NodePath(root->get_path_to(exists).get_names(),
                          track_clipboard[i].full_path.get_subnames(), false);
        }
      }

      undo_redo->add_do_method(animation.ptr(), "track_set_path", base_track,
                               path);
      undo_redo->add_do_method(animation.ptr(), "track_set_interpolation_type",
                               base_track, track_clipboard[i].interp_type);
      undo_redo->add_do_method(animation.ptr(),
                               "track_set_interpolation_loop_wrap", base_track,
                               track_clipboard[i].loop_wrap);
      undo_redo->add_do_method(animation.ptr(), "track_set_enabled", base_track,
                               track_clipboard[i].enabled);
      if (track_clipboard[i].track_type == Animation::TYPE_VALUE) {
        undo_redo->add_do_method(animation.ptr(), "value_track_set_update_mode",
                                 base_track, track_clipboard[i].update_mode);
      }

      for (int j = 0; j < track_clipboard[i].keys.size(); j++) {
        undo_redo->add_do_method(animation.ptr(), "track_insert_key",
                                 base_track, track_clipboard[i].keys[j].time,
...
#define _NEW_POS(m_ofs)                                                        \
  (((s > 0) ? m_ofs : from_t + (len - (m_ofs - from_t))) - pivot) * ABS(s) +   \
    ...
    for (Map<SelectedKey, KeyInfo>::Element *E = selection.back(); E;
      ...
      float newpos = _NEW_POS(E->get().pos);
      undo_redo->add_undo_method(animation.ptr(),
                                 "track_remove_key_at_position", E->key().track,
                                 newpos);
    }
    ...
    for (Map<SelectedKey, KeyInfo>::Element *E = selection.back(); E;
      ...
      if (newpos >= 0)
        undo_redo->add_do_method(this, "_select_at_anim", animation,
                                 E->key().track, newpos);
      undo_redo->add_undo_method(this, "_select_at_anim", animation,
                                 E->key().track, oldpos);
    }
#undef _NEW_POS
  ...
  case EDIT_DUPLICATE_TRANSPOSED: {
    if (bezier_edit->is_visible()) {
      EditorNode::get_singleton()->show_warning(
          TTR("This option does not work for Bezier editing, as it's only a "
              "single track."));
      break;
    }
  ...
  case EDIT_OPTIMIZE_ANIMATION_CONFIRM: {
    animation->optimize(optimize_linear_error->get_value(),
  ...
  case EDIT_CLEAN_UP_ANIMATION_CONFIRM: {
    if (cleanup_all->is_pressed()) {
      ...
      AnimationPlayerEditor::singleton->get_player()->get_animation_list(
          &names);
      for (List<StringName>::Element *E = names.front(); E; E = E->next()) {
        _cleanup_animation(
            AnimationPlayerEditor::singleton->get_player()->get_animation(
                E->get()));
      }
    } else {
...
void AnimationTrackEditor::_cleanup_animation(Ref<Animation> p_animation) {
  ...
  for (int i = 0; i < p_animation->get_track_count(); i++) {
    ...
    Node *node = root->get_node_and_resource(p_animation->track_get_path(i),
                                             res, leftover_path);
...
void AnimationTrackEditor::_show_imported_anim_warning() {
  ...
  // line breaks yet.
  EditorNode::get_singleton()->show_warning(
      TTR("This animation belongs to an imported scene, so changes to imported "
          "tracks will not be saved.\n\nTo enable the ability to add custom "
          "tracks, navigate to the scene's import settings and "
          "set\n\"Animation > Storage\" to \"Files\", enable \"Animation > "
          "Keep Custom Tracks\", then re-import.\nAlternatively, use an import "
          "preset that imports animations to separate files."),
...
void AnimationTrackEditor::_bind_methods() {
  ...
  ClassDB::bind_method("_animation_update",
                       &AnimationTrackEditor::_animation_update);
  ClassDB::bind_method("_track_grab_focus",
  ...
  ClassDB::bind_method("_clear_selection_for_anim",
                       &AnimationTrackEditor::_clear_selection_for_anim);
  ClassDB::bind_method("_select_at_anim",
                       &AnimationTrackEditor::_select_at_anim);

  ClassDB::bind_method(
      "_key_selected",
      &AnimationTrackEditor::_key_selected); // Still used by some
                                             // connect_compat.
  ClassDB::bind_method(
      "_key_deselected",
      &AnimationTrackEditor::_key_deselected); // Still used by some
                                               // connect_compat.
  ClassDB::bind_method(
      "_clear_selection",
      &AnimationTrackEditor::_clear_selection); // Still used by some
                                                // connect_compat.
  ...
  ADD_SIGNAL(
      MethodInfo("animation_len_changed", PropertyInfo(Variant::FLOAT, "len")));
  ADD_SIGNAL(MethodInfo("animation_step_changed",
...
AnimationTrackEditor::AnimationTrackEditor() {
  ...
  info_message->set_anchors_and_margins_preset(
      PRESET_WIDE, PRESET_MODE_KEEP_SIZE, 8 * EDSCALE);
  ...
  timeline->connect(
      "name_limit_changed",
      callable_mp(this, &AnimationTrackEditor::_name_limit_changed));
  timeline->connect("track_added",
                    callable_mp(this, &AnimationTrackEditor::_add_track));
  timeline->connect(
      "value_changed",
      callable_mp(this, &AnimationTrackEditor::_timeline_value_changed));
  timeline->connect("length_changed",
                    callable_mp(this, &AnimationTrackEditor::_update_length));
  ...
  timeline_scroll->add_child(
      sb); // move here so timeline and tracks are always aligned
  scroll->connect("gui_input",
                  callable_mp(this, &AnimationTrackEditor::_scroll_input));
  ...
  bezier_edit->connect(
      "close_request",
      callable_mp(this, &AnimationTrackEditor::_cancel_bezier_edit));
  ...
  hscroll->hide();
  hscroll->connect("value_changed",
                   callable_mp(this, &AnimationTrackEditor::_update_scroll));
  ...
  imported_anim_warning->hide();
  imported_anim_warning->set_tooltip(
      TTR("Warning: Editing imported animation"));
  imported_anim_warning->connect(
      "pressed",
      callable_mp(this, &AnimationTrackEditor::_show_imported_anim_warning));
  ...
  selected_filter->connect(
      "pressed",
      callable_mp(this,
                  &AnimationTrackEditor::_view_group_toggle)); // same function
                                                               // works the same
  ...
  view_group->connect(
      "pressed", callable_mp(this, &AnimationTrackEditor::_view_group_toggle));
  ...
  step->connect("value_changed",
                callable_mp(this, &AnimationTrackEditor::_update_step));
  step->set_read_only(true);
  ...
  snap_mode->connect(
      "item_selected",
      callable_mp(this, &AnimationTrackEditor::_snap_mode_changed));
  snap_mode->set_disabled(true);
  ...
  edit->get_popup()->add_shortcut(
      ED_SHORTCUT("animation_editor/duplicate_selection",
                  TTR("Duplicate Selection"), KEY_MASK_CMD | KEY_D),
      EDIT_DUPLICATE_SELECTION);
  edit->get_popup()->add_shortcut(
      ED_SHORTCUT("animation_editor/duplicate_selection_transposed",
  ...
  edit->get_popup()->set_item_shortcut_disabled(
      edit->get_popup()->get_item_index(EDIT_DUPLICATE_SELECTION), true);
  edit->get_popup()->set_item_shortcut_disabled(
      edit->get_popup()->get_item_index(EDIT_DUPLICATE_TRANSPOSED), true);
  edit->get_popup()->add_separator();
  edit->get_popup()->add_shortcut(
      ED_SHORTCUT("animation_editor/delete_selection", TTR("Delete Selection"),
                  KEY_DELETE),
      EDIT_DELETE_SELECTION);
  edit->get_popup()->set_item_shortcut_disabled(
      edit->get_popup()->get_item_index(EDIT_DELETE_SELECTION), true);
  // this shortcut will be checked from the track itself. so no need to enable
  // it here (will conflict with scenetree dock)

  edit->get_popup()->add_separator();
  edit->get_popup()->add_shortcut(ED_SHORTCUT("animation_editor/goto_next_step",
                                              TTR("Go to Next Step"),
                                              KEY_MASK_CMD | KEY_RIGHT),
                                  EDIT_GOTO_NEXT_STEP);
  edit->get_popup()->add_shortcut(ED_SHORTCUT("animation_editor/goto_prev_step",
  ...
  edit->get_popup()->add_item(TTR("Clean-Up Animation"),
                              EDIT_CLEAN_UP_ANIMATION);

  edit->get_popup()->connect(
      "id_pressed",
      callable_mp(this, &AnimationTrackEditor::_edit_menu_pressed));
  ...
  pick_track->connect(
      "selected",
      callable_mp(this, &AnimationTrackEditor::_new_track_node_selected));
  prop_selector = memnew(PropertySelector);
  add_child(prop_selector);
  prop_selector->connect(
      "selected",
      callable_mp(this, &AnimationTrackEditor::_new_track_property_selected));

  method_selector = memnew(PropertySelector);
  add_child(method_selector);
  method_selector->connect(
      "selected", callable_mp(this, &AnimationTrackEditor::_add_method_key));
  ...
  insert_confirm->connect(
      "confirmed",
      callable_mp(this, &AnimationTrackEditor::_confirm_insert_list));
  ...
  box_selection->hide();
  box_selection->connect(
      "draw", callable_mp(this, &AnimationTrackEditor::_box_selection_draw));
  box_selecting = false;
  ...
  optimize_vb->add_margin_child(TTR("Max. Linear Error:"),
  ...
  optimize_vb->add_margin_child(TTR("Max. Angular Error:"),
                                optimize_angular_error);
  optimize_max_angle = memnew(SpinBox);
  optimize_vb->add_margin_child(TTR("Max Optimizable Angle:"),
                                optimize_max_angle);
  ...
  optimize_dialog->connect(
      "confirmed", callable_mp(this, &AnimationTrackEditor::_edit_menu_pressed),
  ...
  select_all_button->connect(
      "pressed",
      callable_mp(this, &AnimationTrackEditor::_select_all_tracks_for_copy));
