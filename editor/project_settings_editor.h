 ...
 * @brief Editor dialog for managing project settings, input maps, translations, and plugins.
 *
 * ProjectSettingsEditor extends AcceptDialog to provide a comprehensive UI for configuring
 * project-wide settings including:
 * - Input action mappings (keyboard, joystick, mouse)
 * - Localization and translation resources
 * - Autoload/singleton settings
 * - Plugin configuration
 * - Project restart notifications
 *
 * The editor uses a tabbed interface to organize different setting categories and supports
 * undo/redo operations through the UndoRedo system.
 *
 * @note This is a singleton class. Access via get_singleton().
 *
 * @see EditorData
 * @see UndoRedo
 * @see EditorAutoloadSettings
 * @see EditorPluginSettings
 */
