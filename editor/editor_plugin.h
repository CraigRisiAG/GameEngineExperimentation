 ...
 * @brief Editor plugin system interface and implementation
 * 
 * This header defines the core classes for the editor plugin system:
 * - EditorInterface: Provides access to editor resources and functionality
 * - EditorPlugin: Base class for all editor plugins with customization hooks
 * - EditorPlugins: Factory system for creating and managing editor plugins
 */

/**
 * @class EditorInterface
 * @brief Singleton interface for accessing editor functionality from plugins
 * 
 * Provides plugins with access to editor state, resources, and operations such as
 * scene management, file selection, object inspection, and UI elements.
 */

/**
 * @class EditorPlugin
 * @brief Base class for all editor plugins
 * 
 * Plugins can override virtual methods to hook into editor events, handle input,
 * draw overlays, and manage UI elements. Supports undo/redo, custom types, and
 * integration with various editor subsystems (importers, exporters, gizmos, etc.).
 * 
 * @note Plugins must implement enable_plugin() and disable_plugin() for lifecycle management
 */

/**
 * @class EditorPlugins
 * @brief Factory and registry for editor plugin creation
 * 
 * Manages the registration and instantiation of editor plugins. Uses a static array
 * of creation functions limited to MAX_CREATE_FUNCS (64) plugins.
 */
