 ...
 * @brief Main editor node implementation for the Godot Engine editor.
 * 
 * This file contains the core EditorNode class which serves as the central hub for the editor UI,
 * managing scenes, plugins, docks, menus, and the overall editor workflow. It handles:
 * - Scene management (loading, saving, switching between scenes)
 * - Editor plugin system (adding/removing plugins, managing editor screens)
 * - UI layout management (docks, panels, menus)
 * - File operations and resource management
 * - Project settings and export functionality
 * - Editor settings and preferences
 * - Debugging and play/stop functionality
 * - Screenshot capture and various editor utilities
 * 
 * The EditorNode is implemented as a singleton and serves as the bridge between the engine
 * and the editor interface, coordinating all editor operations and maintaining editor state.
 */
